...
C   02-05-22  GEOFF MANIKIN - CHANGED CALL TO HELICITY PROGRAM TO
C                              ALLOW FOR IT TO BE COMPUTED OVER TWO
C                              DIFFERENT (0-1 and 0-3 KM) DEPTHS; ALSO
C                              ADDED MIXED-LAYER CAPE AND CINS OPTIONS
C     
...
C        HELICITY AND STORM MOTION.
     ...
     X           GRID1,IMOUT,JMOUT)
           ...
           ID(10)   = 10
           ID(11)   = 0
           CALL OUTPUT(IOUTYP,IGET(162),LVLS(2,IGET(162)),
     X           GRID1,IMOUT,JMOUT)
           ENDIF
         ENDIF
...
cwas              IF(P78483(I,J).LT.PKL1.AND.P78483(I,J).GT.PKU1)THEN
                  IF(P78483(I,J).LE.PKL1.AND.P78483(I,J).GE.PKU1)THEN
                    FAC1=(PKL1-P78483(I,J))/(PKL1-PKU1)
                    FAC2=(P78483(I,J)-PKU1)/(PKL1-PKU1)
                    T78483(I,J)=T(I,J,L)*FAC2+T(I,J,L-1)*FAC1
                  ENDIF
cwas              IF(P89671(I,J).LT.PKL1.AND.P89671(I,J).GT.PKU1)THEN
                  IF(P89671(I,J).LE.PKL1.AND.P89671(I,J).GE.PKU1)THEN
...
C
     ...
     X                  GRID1,GRID2,IMOUT,JMOUT)
             ...
             ID(10)   = PETABND(3)+15.
             ID(11)   = PETABND(1)-15.
             CALL OUTPUT(IOUTYP,IGET(032),LVLS(3,IGET(032)),
     X                   GRID1,IMOUT,JMOUT)
           ENDIF
...
C
             ...
             ID(10)   = PETABND(3)+15.
             ID(11)   = PETABND(1)-15.
             CALL OUTPUT(IOUTYP,IGET(107),LVLS(3,IGET(107)),
     X                   GRID1,IMOUT,JMOUT)
           ENDIF
         ENDIF
C     
