...
C     
      IF ((KGTYPE.GE.90).AND.(KGTYPE.LE.196)) THEN
c     IF (KGTYPE.EQ.90.OR.KGTYPE.EQ.92.OR.
c    X      KGTYPE.EQ.94.OR.KGTYPE.EQ.96
c    X      .OR.KGTYPE.EQ.99.OR.KGTYPE.EQ.190.OR.KGTYPE.EQ.192
c    X      .OR.KGTYPE.EQ.194.OR.KGTYPE.EQ.196) THEN
c          call ps7
...
C
C
C     NONE OF THE STUFF BELOW HERE IS USED - THE CODE ALWAYS GOTOS 400
C
C     
