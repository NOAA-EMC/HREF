      SUBROUTINE TTBLEX(TREF,TTBL,ITB,JTB,KARR,PDSL,SGML1L
     1,SGML2L,PDTOP,HTML,PT,PL,QQ,PP,RDP,THE0,STHE,RDTHE,THESP
     2,                 IPTB,ITHTB)
CFPP$ NOCONCUR R
...
C----------------------------------------------------------------------
                             D I M E N S I O N
     1 TREF(IM,JSTA_2L:JEND_2U),TTBL(JTB,ITB),KARR(IM,JM),PDSL(IM,JM),
     8 HTML(IM,JSTA_2L:JEND_2U)
...
C--------------SCALING PRESSURE & TT TABLE INDEX------------------------
        PK=PDTOP*SGML1L+PDSL(I,J)*SGML2L+PT
        TPK=(PK-PL)*RDP
        QQ(I,J)=TPK-AINT(TPK)
        IPTB(I,J)=INT(TPK)+1
