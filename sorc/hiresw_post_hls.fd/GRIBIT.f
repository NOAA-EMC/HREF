...
c     DO J=1,JMOUT
c     DO I=1,IMOUT
c       GRIDOT(I,J)=GRID(I,J)
c     ENDDO
c     ENDDO
C
c     DO J=1,JMOUT
c     DO I=1,IMOUT
c       IBITM=IBITM+IBMAP(I,J)
c     ENDDO
c     ENDDO
      ibitm = imout * jmout
C
...
C        ID(11) = VALUE 2 OF LEVEL
666   WRITE(STDOUT,1050) ID(8),FIELD(IFLD),ID(9),ID(10),ID(11)
