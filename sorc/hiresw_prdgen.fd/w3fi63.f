...
C   02-01-14  ROGERS      CHANGED GRIDS 90-92, 97, AND 192 FROM 10 KM ETA 
C                         TO 8 KM MESO; CHANGED GRID 93 FROM 12 KM ETA
C                         TO 10 KM MESO; CHANGED GRIDS 101-126 FOR 
C                         4 KM MESO; CHANGED GRIDS 151-176 FOR 4 KM MESO
C                         OUTPUT GRIDS
C
...
C                       ----- U.S. GRID 100 - MAP SIZE 6889
                  J     = 6889
                  GO TO 800
              ELSE IF (KPDS(3).GE.101.AND.KPDS(3).LE.126) THEN
C                  -----  U.S. GRID  101-126 - MAP SIZE 111723
                  J   = 111723
                  GO TO 800
              ELSE IF (KPDS(3).GE.151.AND.KPDS(3).LE.172) THEN
C                  -----  U.S. GRID  151-172 - MAP SIZE 121808
                  J   = 121808
                  GO TO 800
              ELSE IF (KPDS(3).GE.173.AND.KPDS(3).LE.175) THEN
C                  -----  U.S. GRID  173-175 - MAP SIZE 121440
                  J   = 121440
                  GO TO 800
              ELSE IF (KPDS(3).EQ.176) THEN
C                  -----  U.S. GRID  176 - MAP SIZE 121808
                  J   = 121808
                  GO TO 800
      ...
      ELSE IF (KPDS(1).EQ.7) THEN
          ...
          ELSE IF (KPDS(3).GE.101.AND.KPDS(3).LE.126) THEN
              IF (I.NE.J) THEN
                  RETURN
              END IF
          ELSE IF (KPDS(3).GE.150.AND.KPDS(3).LE.176) THEN
              IF (I.NE.J) THEN
                  RETURN
              END IF
