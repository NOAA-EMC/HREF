...
CONTAINS
     ...
     &                                             QWFLIP,TFLIP
      ...
      REAL, OPTIONAL, INTENT(OUT), DIMENSION(ims:ime,jms:jme)  :: COSZ_URB2D  
      REAL, OPTIONAL, INTENT(OUT), DIMENSION(ims:ime,jms:jme)  :: OMG_URB2D   
  ...
  END SUBROUTINE ETARA
     ...
     &                OMG_URB2D)                                         
      ...
      DO J=MYJS,MYJE              
      DO I=MYIS,MYIE              
      if(present(COSZ_URB2D)) COSZ_URB2D(I,J)=CZEN(I,J)   
      ENDDO                       
      ENDDO                       
...
255       CONTINUE         
  ...
  700                          CONTINUE
   ...
   10   CONTINUE
      ...
      CZEN(I,J)=SINALT
      if(present(OMG_URB2D))OMG_URB2D(I,J)=HRLCL  
  100 CONTINUE
