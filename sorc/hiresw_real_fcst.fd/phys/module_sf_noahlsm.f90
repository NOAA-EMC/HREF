...
CONTAINS
      ...
      SUBROUTINE SFLX (FFROZP,ICE,ISURBAN,DT,ZLVL,NSOIL,SLDPTH,         &    
                       LOCAL,                                           &    
                       LLANDUSE, LSOIL,                                 &    
