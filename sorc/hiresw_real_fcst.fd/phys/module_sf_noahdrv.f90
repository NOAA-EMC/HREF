...
CONTAINS
  ...
  character(len=80) :: message_text
   ...
   70     CONTINUE
       ...
       CALL SFLX (FFROZP, ICE, ISURBAN, DT,ZLVL,NSOIL,SLDPTH,     &    
                 LOCAL,                                           &    
                 LUTYPE, SLTYPE,                                  &    
