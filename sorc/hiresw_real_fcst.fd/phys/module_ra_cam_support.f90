MODULE module_ra_cam_support
  ...
  real(r8):: ah2onw(n_p, n_tp, n_u, n_te, n_rh)   
  real(r8):: eh2onw(n_p, n_tp, n_u, n_te, n_rh)   
  real(r8):: ah2ow(n_p, n_tp, n_u, n_te, n_rh)    
  real(r8):: cn_ah2ow(n_p, n_tp, n_u, n_te, n_rh)    
  real(r8):: cn_eh2ow(n_p, n_tp, n_u, n_te, n_rh)    
  real(r8):: ln_ah2ow(n_p, n_tp, n_u, n_te, n_rh)    
  real(r8):: ln_eh2ow(n_p, n_tp, n_u, n_te, n_rh)    
...
real(r8) :: wsul(nrh, nspint)    
real(r8) :: gsul(nrh, nspint)    
real(r8) :: kbg(nspint)          
real(r8) :: wbg(nspint)          
real(r8) :: gbg(nspint)          
real(r8) :: ksslt(nrh, nspint)   
real(r8) :: wsslt(nrh, nspint)   
real(r8) :: gsslt(nrh, nspint)   
real(r8) :: kcphil(nrh, nspint)  
real(r8) :: wcphil(nrh, nspint)  
real(r8) :: gcphil(nrh, nspint)  
