...
SUBROUTINE med_filter_out ( grid , config_flags )
   ...
   END IF
     ...
     IF ( ierr .NE. 0 ) THEN
       CALL wrf_error_fatal3("",931,&
message )
     ENDIF

     IF ( ierr .NE. 0 ) THEN
       CALL wrf_error_fatal3("",936,&
message )
     ENDIF
