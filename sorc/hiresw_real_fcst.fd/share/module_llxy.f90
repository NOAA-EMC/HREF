...
'MAP_INIT' )
      ...
      ELSE IF ( proj_code == PROJ_ROTLL ) THEN
         IF ( .NOT.PRESENT(ixdim) .OR. &
            ...
            CALL wrf_error_fatal3("",433,&
'MAP_INIT' )
         END IF
      ELSE
         PRINT '(A,I2)', 'Unknown projection code: ', proj_code
         CALL wrf_error_fatal3("",438,&
'MAP_INIT' )
      END IF
