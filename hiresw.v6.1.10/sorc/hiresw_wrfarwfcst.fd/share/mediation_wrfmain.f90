...
SUBROUTINE med_add_config_info_to_grid ( grid )
 ...
 grid % sim_start_year             = model_config_rec % sim_start_year (grid%id)
 grid % sim_start_month            = model_config_rec % sim_start_month (grid%id)
 grid % sim_start_day              = model_config_rec % sim_start_day (grid%id)
 grid % sim_start_hour             = model_config_rec % sim_start_hour (grid%id)
