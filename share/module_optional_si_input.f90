MODULE module_optional_si_input
   ...
   INTEGER :: flag_metgrid  , flag_tavgsfc  , flag_psfc     , flag_soilhgt

   INTEGER :: flag_qv       , flag_qc       , flag_qr       , flag_qi       , flag_qs       , flag_qg
...
USE module_io_domain
      ...
      !  OK, lets do a quick sanity check.
      ...
      IF ( ( num_st_levels_input .GT. num_st_levels_alloc ) .OR. &
         ...
         CALL wrf_error_fatal3 ( "module_optional_si_input.b" , 981 ,  'soil_levels_too_few' )
      END IF
