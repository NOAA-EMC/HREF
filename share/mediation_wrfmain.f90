...
! typically <date> will not be part of input_inname but allow for it
        ...
        IF ( ierr .NE. 0 ) THEN
          ...
          CALL wrf_error_fatal3 ( "mediation_wrfmain.b" , 69 ,  wrf_err_message )
        ENDIF
        ...
        ELSE
           ...
           CALL wrf_error_fatal3 ( "mediation_wrfmain.b" , 121 ,  message )
        END IF
   ...
   ELSE
     ...
     IF ( ierr .NE. 0 ) THEN
       ...
       CALL wrf_error_fatal3 ( "mediation_wrfmain.b" , 143 ,  message )
     ENDIF
