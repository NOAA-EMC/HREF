...
echo $dom is conus for defining the variable parm file
 ...
 then
  if [ ${ff}%3 -eq 0 ]
  then
    ln -sf $PARMrefs/enspost_variable_grib2.tbl_3h_${subtype} variable.tbl
  else
    ln -sf $PARMrefs/enspost_variable_grib2.tbl_${subtype}    variable.tbl
  fi
 else
...
echo $dom is nonconus for defining the variable parm file
 ...
 then
  if [ ${ff}%3 -eq 0 ]
  then
    ln -sf $PARMrefs/enspost_variable_grib2.tbl_3h_nonconus_${subtype} variable.tbl
  else
    ln -sf $PARMrefs/enspost_variable_grib2.tbl_nonconus_${subtype}   variable.tbl
  fi
 else
