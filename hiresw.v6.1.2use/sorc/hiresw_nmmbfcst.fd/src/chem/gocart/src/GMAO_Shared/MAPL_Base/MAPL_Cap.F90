!  $Id: MAPL_Cap.F90,v 1.37.12.4.14.6.2.1 2014-07-01 00:47:29 atrayano Exp $
...
!-----------------
   ...
   ! ------------------
      ...
      if( LPERP ) then
          ...
          call Perpetual_Clock ( clock, clock_HIST, PERPETUAL_YEAR, PERPETUAL_MONTH, PERPETUAL_DAY, AmIRoot_, STATUS )
          VERIFY_(STATUS)
      endif
...
!we have to bypass next line
   ...
   subroutine Perpetual_Clock ( clock, clock_HIST, PERPETUAL_YEAR, PERPETUAL_MONTH, PERPETUAL_DAY, AmIRoot, rc )
