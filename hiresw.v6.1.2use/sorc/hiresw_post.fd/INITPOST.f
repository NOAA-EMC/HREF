...
! if(jj.ge. jsta .and. jj.le.jend)print*,'sample Q= ',Q(ii,jj,ll)
      ...
      do l = 1, lm
       do j = jsta_2l, jend_2u
        ...
        write(0,*) 'I,J,L, PMID(I,J,L): ', I,J,L, PMID(I,J,L)
        endif
...
! end if
      ...
      DO L=2,LM
        ...
        if (I .eq. 50 .and. J .eq. 50) then
        write(0,*) 'I,J, PMID(L-1), PMID(L), PINT(I,J,L): ', &
               I,J,L, PMID(I,J,L-1), PMID(I,J,L), PINT(I,J,L)
        endif
...
! ph/phb are geopotential z=(ph+phb)/9.801
      DO L=1,LM+1
        ...
        if (I .eq. 50 .and. J .eq. 50) then
        write(0,*) 'I,J,L, ZINT(I,J,L): ', I,J,L, ZINT(I,J,L)
        endif
...
!tst      ENDIF ! IF(MODELNAME == 'RAPR')THEN
