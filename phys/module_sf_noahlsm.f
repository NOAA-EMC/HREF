...
!                                                                       
       ...
       CALL SFLX (ICE,DT,ZLVL,NSOIL,SLDPTH,                       &    !C
                 ...
                 TH2,Q2SAT,DQSDT2,                                &    !I
                 VEGTYP,SOILTYP,SLOPETYP,SHDFAC,SHMIN,DUMMY,     &    !I   SHMIN
                 ALBBRD, SNOALB1,TBOT, Z0BRD, Z0K,                 &    !S SNOALB1
...
! initialize soil liquid water content SH2O
	...
	write(6,*) 'skip SH2O initialization here'
!	goto 969

!m  IF(.NOT.FNDSOILW) THEN
...
! first guess.
	...
	if (abs(SH2O(I,NS,J)) .lt. 1.2) then
!
	else
	write(0,*) 'bad SH2O in explicit...I,NS,J,SH2O: ', I,NS,J,&
                                         SH2O(I,NS,J)
	write(0,*) 'ISLTYP, SMCMAX:: ', ISLTYP(I,J), SMCMAX
	endif

	if (NS .eq. 1) then
	write(0,*) 'first lev I,J,TSLB, SMOIS:: ',I,J, TSLB(I,NS,J),SMOIS(I,NS,J)
	endif
...
!
	...
	write(0,*) 'bad SH2O from FRH2O...I,NS,J,SH2O: ', I,NS,J,&
                                         SH2O(I,NS,J)
!	write(0,*) ISLTYP, SMCMAX:: , ISLTYP(I,J), SMCMAX
	write(0,*) 'TSLB, SMOIS:: ', TSLB(I,NS,J),SMOIS(I,NS,J)
	endif
...
! ----------------------------------------------------------------------
        ...
        ENDDO                 ! DO I = its,itf
        ENDDO                 ! DO J = jts,jtf
!m  ENDIF                       ! of IF(.NOT.FNDSOILW)THEN 
...
!                                                                       
	...
	write(6,*) 'leave SOIL_VEG_GEN_PARM'
...
!            BETA = ETA/ETP                                                      
         ELSE                                                                    
            CALL SNOPAC (ETP,ETA,PRCP,PRCPF,SNOWNG,SMC,SMCMAX,SMCWLT,    & 
                         ...
                         BETA,DRIP,DEW,FLX1,FLX2,FLX3,ESNOW,ETNS)               
...
! ----------------------------------------------------------------------         
      HCPCT = SH2O (1)* CH2O + (1.0- SMCMAX)* CSOIL + (SMCMAX - SMC (1))&        
       * CAIR                                                           &        
              + ( SMC (1) - SH2O (1) )* CICE                                     
...
! ----------------------------------------------------------------------         
      DO K = 2,NSOIL                                                             
         HCPCT = SH2O (K)* CH2O + (1.0- SMCMAX)* CSOIL + (SMCMAX - SMC (  &        
...
! ----------------------------------------------------------------------         
      ...
      INTEGER, INTENT(IN)  :: ICE, NROOT,NSOIL
      INTEGER              :: K
