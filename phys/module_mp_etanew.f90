...
!-----------------------------------------------------------------------
     ...
     &  RFmax, RQR_DRmin, RQR_DRmax,                                    &
     &  RR_DRmin, RR_DR1, RR_DR2, RR_DR3, RR_DR4, RR_DR5
!
...
!
   ...
   !
        ...
        !      V(Dr)=2855.8*Dr**.801, V in m/s and Dr in m
        !      RR = PI*1000.*N0r0*2855.8*Dr**(4+.801) = 7.1774e13*Dr**4.801, 
        !        RR in kg/(m**2*s)
...
!
        IF ( etampnew_unit1 < 0 ) THEN
          CALL wrf_error_fatal3 ( "module_mp_etanew.b" , 2209 ,  'module_mp_etanew: etanewinit: Can not find '// &
...
9061 CONTINUE
     ...
     &, etampnew_unit1
      CALL wrf_error_fatal3 ( "module_mp_etanew.b" , 2376 , errmess)
!
!-----------------------------------------------------------------------
