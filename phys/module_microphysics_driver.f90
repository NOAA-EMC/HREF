...
!-----------
       IF( PRESENT( QNDROP_CURR ) ) THEN
          IF( F_QNDROP .AND. mp_physics==LINSCHEME ) THEN
...
! 06-nov-2005 rce - id  & itimestep added to arg list
             call prescribe_aerosol_mixactivate (               &
                  ...
                  F_QC=f_qc, F_QI=f_qi                          )
          ELSE IF( F_QNDROP ) THEN
             CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 325 , "SETTINGS ERROR: Prognostic cloud droplet number can only be used with the mp_physics=LINSCHEME.")
          END IF
       END IF
     ...
     micro_select: SELECT CASE(mp_physics)
        ...
        CASE (KESSLERSCHEME)
             ...
             ELSE 
                CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 353 ,  'arguments not present for calling kessler' )
             ENDIF
...
!
        CASE (THOMPSON)
             ...
             CALL mp_gt_driver(                          &
                 ...
                 ,ITS=its,ITE=ite, JTS=jts,JTE=jte, KTS=kts,KTE=kte)
             ELSE
                CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 385 ,  'arguments not present for calling thompson_et_al' )
             ENDIF
!
        CASE (LINSCHEME)
             ...
             ELSE 
                CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 420 ,  'arguments not present for calling lin_et_al' )
             ENDIF
        ...
        CASE (WSM3SCHEME)
             ...
             ELSE 
                CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 449 ,  'arguments not present for calling wsm3' )
             ENDIF
        ...
        CASE (WSM5SCHEME)
             ...
             ELSE
                CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 480 ,  'arguments not present for calling wsm5' )
             ENDIF
        ...
        CASE (WSM6SCHEME)
             ...
             ELSE
                CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 513 ,  'arguments not present for calling wsm6' )
             ENDIF
        ...
        CASE (ETAMPNEW)
             ...
             ELSE
                CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 543 ,  'arguments not present for calling etampnew' )
             ENDIF
        ...
        CASE (NCEPCLOUD3)
             ...
             ELSE
                CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 571 ,  'arguments not present for calling ncepcloud3' )
             ENDIF
        ...
        CASE (NCEPCLOUD5)
             ...
             ELSE
                CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 601 ,  'arguments not present for calling ncepcloud5' )
             ENDIF
      ...
      CASE DEFAULT 
         ...
         CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 608 ,  wrf_err_message )
