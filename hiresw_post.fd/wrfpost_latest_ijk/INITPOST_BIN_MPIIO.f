...
!!!  +  ,buf3d(im,lm,jsta_2l:jend_2u),buf3d2(im,lp1,jsta_2l:jend_2u)
     +  ,buf3d(im,jm,lm),buf3d2(im,jm,lp1)
     +  ,buf3dx(im,lm,jm)
C
      DATA BLANK/'    '/
C
...
! SECOND, INTEGRATE HEIGHT HYDROSTATICLY
     ...
     3  ALPINT(I,J,L),ZINT(I,J,L)
      ...
      write(0,*)' zmid lbounds=',lbound(zmid)
     &         ,' ubounds=',ubound(zmid)
      write(0,*)' zint lbounds=',lbound(zint)
     &         ,' ubounds=',ubound(zint)
      write(0,*)' pmid lbounds=',lbound(pmid)
     &         ,' ubounds=',ubound(pmid)
      write(0,*)' pint lbounds=',lbound(pint)
     &         ,' ubounds=',ubound(pint)
!
      DO L=1,LM
!      write(0,*)' zmid l=',l
