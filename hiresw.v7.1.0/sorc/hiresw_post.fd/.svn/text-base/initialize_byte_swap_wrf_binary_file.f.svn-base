...
!   integer(i_llong),parameter:: lword=2**10_i_llong
  ...
  write(0,*) 'i_kind: ', i_kind
  write(0,*) 'i_llong: ', i_llong


  cwrfges = wrfges
  cwrfges(7:7) = char(0)
	write(0,*) 'here in_unit: ', in_unit
	write(0,*) 'cwrfges: ', cwrfges
  call openfileread (in_unit, ierr, cwrfges)
	write(0,*) 'ierr from open: ', ierr
