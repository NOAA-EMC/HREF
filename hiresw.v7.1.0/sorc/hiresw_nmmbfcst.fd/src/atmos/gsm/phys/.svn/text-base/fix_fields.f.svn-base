     ...
     &                  cread_nst,nblck,phy_f3d,phy_f2d)
!!     
!! Code Revision
...
!
      integer              nblck
      real (kind=kind_rad) phy_f3d(NGPTC,LEVS,num_p3d+npdf3d,
     &                                     NBLCK,LATS_NODE_R)
...
!
        ...
        CALL read_sfc_r(cread,sfc_fld,phy_f2d,phy_f3d,num_p3d+npdf3d,
     &                  num_p2d,NGPTC,NBLCK,GLOBAL_LATS_R,LONSPERLAR,
