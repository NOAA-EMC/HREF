...
!      print *,'in para_fix_w'
      ...
      nphyfld=nsfcrec+3*lsoil+num_p2d+(num_p3d+npdf3d)*levs
...
!
          nrecs=nsfcrec
          nrecs1=nrecs+1
          nrec=nrecs+3*nsoil+(num_p3d+npdf3d)*levs+num_p2d
!          write(0,*)'after nrec=',nrec,'nsoil=',nsoil,'num_p3d=',
!     &      num_p3d,'num_p2d=',num_p2d,' npdf3d=',npdf3d
...
!
     ...
     &       3*nsoil+(num_p3d+npdf3d)*levs+num_p2d)='mid layer'
