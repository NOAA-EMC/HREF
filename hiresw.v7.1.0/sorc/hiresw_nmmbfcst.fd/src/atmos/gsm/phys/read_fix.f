...
!
      ...
      use namelist_physics_def, only: use_ufo
      implicit none
...
!
     ...
     &,                     buffo, buff2
      ...
      integer i,j,k,nmtn,needoro,iop
!
      kmsk0 = 0
      iop = nodes_comp - 1
!
...
!!
      ...
      ifldu=ifldu+1
!!
! all fcst node need to send data
...
!         ----------------
         ...
         msgtag=1000+(me+1)*nodesr*maxfld+ifldu
!         print *,'sending data to ioproc=',ioproc,'mes=',msgtag,
...
!
     ...
     &           lsidea,pr_idea,gg,prsilvl,amgms,npdf3d)
!
!***********************************************************************
!
! !REVISION HISTORY:
