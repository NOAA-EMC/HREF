...
! BUG: Need to more correctly handle dx/dy in meters.
      ...
      title = 'OUTPUT FROM METGRID V3.5' 
      ...
      call get_bottom_top_dim(bottom_top_dim)
        INQUIRE (UNIT=47, OPENED=lopen)
        write(0,*) 'lopen unit 47: ', lopen
        if (lopen) then
      write(47) cen_lat, cen_lon, truelat1, truelat2, map_proj
        write(0,*) 'also wrote truelat1, truelat2, map_proj: ', &
             truelat1,truelat2,map_proj
        endif
