...
try:
 # apcp36h
  apcp36h=grbs.select(stepType='accum',name='Total Precipitation',lengthOfTimeRange=36)[0].values
...
#       cm=plt.get_cmap(name='gist_ncar')
       ...
       plt.savefig('./spcprod_apcp6h_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#--------------------------------------------------------------------------------------------    
      ...
      #Now plot apcp36h
       ...
       plt.savefig('./spcprod_apcp36h_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
