#! /bin/sh
#BSUB -oo /gpfs/hps/emc/meso/noscrub/Matthew.Pyle/python_tools/test_graphics.out_pyth_12z_sseo
#BSUB -eo /gpfs/hps/emc/meso/noscrub/Matthew.Pyle/python_tools/test_graphics.err_pyth_12z_sseo
#BSUB -M 1500
#BSUB -P HRW-T2O
