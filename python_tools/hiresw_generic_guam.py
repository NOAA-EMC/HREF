...
try:
  ...
  print 'max refd: ', np.max(onekmrefd)
except:
  onekmrefd=None
...
#mptest    m.fillcontinents(color='#ddaa66', lake_color='#7777ff', zorder = 0)
    ...
    m.drawcoastlines(linewidth=1.50,color='#2d1022')
    ...
    if dom != 'CONUS' and dom != 'AK' and dom != 'PR' and dom != 'HI' and dom != 'GUAM' :
    ...
    if dbz is not None:
      ...
      subprocess.call(['rm','hiresw_refc_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#      cs = m.contourf(lons,lats,etop,clevs,colors=colors,latlon=True,extend='max')
      ...
      subprocess.call(['rm','hiresw_etop_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#--------------------------------------------------------------------------------------------
    if csnow is not None:
      # Get the next plot ready instantaneous CSNOW
       t1=time.clock()
      ...
      # Clear off old plottables but keep all the map info
       ...
       subprocess.call(['rm','hiresw_csnow_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
    ...
    if crain is not None:
      ...
      # Clear off old plottables but keep all the map info
       ...
       subprocess.call(['rm','hiresw_crain_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
    ...
    if cicep is not None:
      ...
      # Clear off old plottables but keep all the map info
       ...
       subprocess.call(['rm','hiresw_cicep_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
    ...
    if cfzr is not None:
      ...
      # Clear off old plottables but keep all the map info
       ...
       subprocess.call(['rm','hiresw_cfzr_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
    ...
    if ptype is not None:
       ...
       subprocess.call(['rm','hiresw_ptypemean_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
       t2 = time.clock()
       t3=round(t2-t1, 3)
...
#       cm=plt.get_cmap(name='gist_ncar')
       ...
       subprocess.call(['rm','hiresw_apcp6h_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#       cm=plt.get_cmap(name='gist_ncar')
       ...
       subprocess.call(['rm','hiresw_apcp1h_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#       cm=plt.get_cmap(name='gist_ncar')
       ...
       subprocess.call(['rm','hiresw_apcp12h_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#------------------------------------
    ...
    if apcp24h is not None:
      ...
      #Now plot apcp24h
       ...
       subprocess.call(['rm','hiresw_apcp24h_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#------------------------------------
    if apcp48h is not None:
      ...
      #Now plot apcp48h
       ...
       subprocess.call(['rm','hiresw_apcp48h_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    ...
    if apcp3h is not None:
      ...
      #Now plot apcp3h
       ...
       subprocess.call(['rm','hiresw_apcp3h_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#------------------------------
    ...
    if apcp6hb is not None:
      ...
      #Now plot apcp6hb
       ...
       plt.savefig('./hiresw_apcp6h_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'hiresw_apcp6h_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'hiresw_apcp6h_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','hiresw_apcp6hb_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if onekmrefdprob40 is not None:
      ...
      #Now plot onekmrefdprob40
       ...
       subprocess.call(['rm','hiresw_onekmrefdprob40_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if mx1kmrefdprob40 is not None:
      ...
      #Now plot mx1kmrefdprob40
       ...
       subprocess.call(['rm','hiresw_mx1kmrefdprob40_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if td2mgt291 is not None:
      ...
      #Now plot td2mgt291
       ...
       plt.savefig('./hiresw_td2mgt291_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'hiresw_td2mgt291_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'hiresw_td2mgt291_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','hiresw_td2mgt291_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if td2mgt285 is not None:
      ...
      #Now plot td2mgt285
       ...
       subprocess.call(['rm','hiresw_td2mgt285_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if ceil610 is not None:
      ...
      #Now plot ceil610
       ...
       subprocess.call(['rm','hiresw_ceil610_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if ceil305 is not None:
      ...
      #Now plot ceil305
       ...
       subprocess.call(['rm','hiresw_ceil305_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if pwat37p5 is not None:
      ...
      #Now plot pwat37p5
       ...
       plt.savefig('./hiresw_pwat37p5_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'hiresw_pwat37p5_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'hiresw_pwat37p5_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','hiresw_pwat37p5_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if mxuphlprob25 is not None:
      ...
      #Now plot 
       ...
       subprocess.call(['rm','hiresw_mxuphlprob25_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
## combo ptype
    ...
    if ptype is not None:
       ...
       subprocess.call(['rm','hiresw_ptype_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
       t2 = time.clock()
       t3=round(t2-t1, 3)
       print("%.3f seconds to plot ptype "+dom) % t3
...
## end combo ptype
    ...
    if t2mprob273 is not None:
      ...
      #Now plot 
       ...
       subprocess.call(['rm','hiresw_t2mprob273_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if windprobgt20 is not None:
      ...
      #Now plot 
       ...
       subprocess.call(['rm','hiresw_windprobgt20_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if windprobgt30 is not None:
      ...
      #Now plot 
       ...
       plt.savefig('./hiresw_windprobgt30_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'hiresw_windprobgt30_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'hiresw_windprobgt30_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','hiresw_windprobgt30_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if etopgt10000 is not None:
      ...
      #Now plot 
       ...
       plt.savefig('./hiresw_etopgt10000_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'hiresw_etopgt10000_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'hiresw_etopgt10000_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','hiresw_etopgt10000_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if etopgt10668 is not None:
      ...
      #Now plot 
       ...
       cbar.set_label('probability')
       plt.title(domid+core+' Prob Echo Top height > ~35K feet \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./hiresw_etopgt10668_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'hiresw_etopgt10668_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'hiresw_etopgt10668_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','hiresw_etopgt10668_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ---------------------------------
    ...
    if apcp3hp254 is not None:
      ...
      #Now plot apcp3hp254
       ...
       subprocess.call(['rm','hiresw_apcp3hp254_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if apcp3h12p4 is not None:
      ...
      #Now plot apcp3h12p4
       ...
       subprocess.call(['rm','hiresw_apcp3h12p4_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if sn3h1inch is not None:
      ...
      #Now plot sn3h1inch
       ...
       subprocess.call(['rm','hiresw_sn3h1inch_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if sn1h1inch is not None:
      ...
      #Now plot sn1h1inch
       ...
       subprocess.call(['rm','hiresw_sn1h1inch_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if sn3h3inch is not None:
      ...
      #Now plot sn3h3inch
       ...
       subprocess.call(['rm','hiresw_sn3h3inch_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if apcp3h12p7 is not None:
      ...
      #Now plot apcp3h12p7
       ...
       subprocess.call(['rm','hiresw_apcp3h12p7_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if apcp1h12p7 is not None:
      ...
      #Now plot apcp1h12p7
       ...
       subprocess.call(['rm','hiresw_apcp1h12p7_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if apcp3h25p1 is not None:
      ...
      #Now plot apcp3h25p1
       ...
       subprocess.call(['rm','hiresw_apcp1h25p1_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
    ...
    if apcp3h25p4 is not None:
      ...
      #Now plot apcp3h25p4
       ...
       subprocess.call(['rm','hiresw_apcp3h25p4_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if apcp3hffg3 is not None:
      ...
      #Now plot apcp3hffg3
       ...
       subprocess.call(['rm','hiresw_apcp3hffg3_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if apcp3hffg4 is not None:
      ...
      #Now plot apcp3hffg4
       ...
       subprocess.call(['rm','hiresw_apcp3hffg4_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if apcp3hri10 is not None:
      ...
      #Now plot apcp3hffg4
       ...
       subprocess.call(['convert','-density', '100x100', 'hiresw_apcp3hri10_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'hiresw_apcp3hffg4_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','hiresw_apcp3hri10_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if apcp6hffg6 is not None:
      ...
      #Now plot apcp6hffg6
       ...
       subprocess.call(['rm','hiresw_apcp3hffg6_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#---------------------------------------------------------------------------------------------    
    ...
    #Now plot REFC dBZ
      ...
      subprocess.call(['rm','hiresw_mx1kmrefd_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#      clab = plt.clabel(cs,clevs[::3],inline=1, fontsize=10,fmt='%.0f')
      ...
      subprocess.call(['rm','hiresw_mxuphl_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ---------------------------------
      ...
      #Now plot apcp36h
       ...
       plt.savefig('./hiresw_apcp36h_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'hiresw_apcp36h_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'hiresw_apcp36h_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','hiresw_apcp36h_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------    
    ...
    if onekmrefd is not None:
      ...
      subprocess.call(['rm','hiresw_1kmrefd_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#-   -------------------------------------------------------------------------------------------    
     ...
     if t2m is not None:
      ...
      subprocess.call(['rm','hiresw_2mtw_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#-   -------------------------------------------------------------------------------------------    
     ...
     if td2m is not None:
      ...
      subprocess.call(['rm','hiresw_2mtdw_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
      t2 = time.clock()
      t3=round(t2-t1, 3)
