...
try:
  # read refc dBZ
  dbz = grbs.select(name='Maximum/Composite radar reflectivity',productDefinitionTemplateNumber=2)[0].values # This is actually REFC dBZ
except:
  dbz=None

try:
  refcgt50 = grbs.select(name='Maximum/Composite radar reflectivity',productDefinitionTemplateNumber=5,scaledValueOfUpperLimit=50000,scaleFactorOfUpperLimit=3)[0].values 
except:
  refcgt50=None

try:
  # read mean cape
  cape = grbs.select(name='Convective available potential energy',productDefinitionTemplateNumber=2,topLevel=9000,bottomLevel=0)[0].values
...
try:
  # read mean 0-6 km shear
  meanshear = grbs.select(name='Vertical speed shear',typeOfLevel="heightAboveGroundLayer",productDefinitionTemplateNumber=2)[0].values
  print 'max meanshear: ', np.max(meanshear)
except:
  print 'no meanshear'
  meanshear=None
...
try:
  # read firewx
  firewx = grbs.select(parameterName="235",typeOfLevel="heightAboveGround",level=10,productDefinitionTemplateNumber=5)[0].values
  print 'max firewx: ', np.max(firewx)
except:
  print 'no firewx'
  firewx=None
...
try:
  # read cape > 500
  cape500 = grbs.select(name='Convective available potential energy',productDefinitionTemplateNumber=5,topLevel=9000,bottomLevel=0,scaledValueOfUpperLimit=500000,scaleFactorOfUpperLimit=3)[0].values
  print 'max cape500: ', np.max(cape500)
except:
  print 'no cape500'
  cape500=None
...
try:
  # read cape > 1000
  cape1000 = grbs.select(name='Convective available potential energy',productDefinitionTemplateNumber=5,topLevel=9000,bottomLevel=0,scaledValueOfUpperLimit=1000000,scaleFactorOfUpperLimit=3)[0].values
  print 'max cape1000: ', np.max(cape1000)
except:
  print 'no cape1000'
  cape1000=None
...
try:
  # read cape > 2000
  cape2000 = grbs.select(name='Convective available potential energy',productDefinitionTemplateNumber=5,topLevel=9000,bottomLevel=0,scaledValueOfUpperLimit=2000000,scaleFactorOfUpperLimit=3)[0].values
  print 'max cape2000: ', np.max(cape2000)
except:
  print 'no cape2000'
  cape2000=None
...
try:
  # read cape > 3000
  cape3000 = grbs.select(name='Convective available potential energy',productDefinitionTemplateNumber=5,topLevel=9000,bottomLevel=0,scaledValueOfUpperLimit=3000000,scaleFactorOfUpperLimit=3)[0].values
  print 'max cape3000: ', np.max(cape3000)
except:
  print 'no cape3000'
  cape3000=None
...
try:
  ...
  productDefinitionTemplateNumber=5,topLevel=5000,bottomLevel=2000,scaledValueOfUpperLimit=25000)[0].values
...
try:
  # 2-5 km MXUPHL
  mxuphlprob100=grbs.select(parameterName="199",typeOfLevel="heightAboveGroundLayer",\
  productDefinitionTemplateNumber=5,topLevel=5000,bottomLevel=2000,scaledValueOfUpperLimit=100000)[0].values
  print 'mxuphlprob100: ', np.max(mxuphlprob100)
except:
  mxuphlprob100=None
  print 'no mxuphlprob100'

try:
  # 2-5 km UPHL
  uphlprob25=grbs.select(parameterName="197",typeOfLevel="heightAboveGroundLayer",\
  productDefinitionTemplateNumber=5,topLevel=5000,bottomLevel=2000,scaledValueOfUpperLimit=25000)[0].values
  print 'uphlprob25: ', np.max(uphlprob25)
except:
  uphlprob25=None
  print 'no uphlprob25'
...
try:
  # 2-5 km UPHL
  uphlprob100=grbs.select(parameterName="197",typeOfLevel="heightAboveGroundLayer",\
  productDefinitionTemplateNumber=5,topLevel=5000,bottomLevel=2000,scaledValueOfUpperLimit=100000)[0].values
  print 'uphlprob100: ', np.max(uphlprob100)
except:
  uphlprob100=None
  print 'no uphlprob100'
...
try:
# apcp6hri5
  apcp6hri5=grbs.select(stepType='accum',name='Total Precipitation',lengthOfTimeRange=6,\
  productDefinitionTemplateNumber=9,scaledValueOfUpperLimit=5000,scaleFactorOfUpperLimit=3)[0].values
  print 'max apcp6hri5: ', np.max(apcp6hri5)
except:
  apcp6hri5=None

try:
# apcp6hri50
  apcp6hri50=grbs.select(stepType='accum',name='Total Precipitation',lengthOfTimeRange=6,\
  productDefinitionTemplateNumber=9,scaledValueOfUpperLimit=50000,scaleFactorOfUpperLimit=3)[0].values
  print 'max apcp6hri50: ', np.max(apcp6hri50)
except:
  apcp6hri50=None

try:
# apcp6hri100
  apcp6hri100=grbs.select(stepType='accum',name='Total Precipitation',lengthOfTimeRange=6,\
  productDefinitionTemplateNumber=9,scaledValueOfUpperLimit=100000,scaleFactorOfUpperLimit=3)[0].values
  print 'max apcp6hri100: ', np.max(apcp6hri100)
except:
  apcp6hri100=None
...
try:
  windprobgt20 = grbs.select(name='10 metre wind speed',typeOfLevel='heightAboveGround',level=10,productDefinitionTemplateNumber=5,scaledValueOfUpperLimit=10300,scaleFactorOfUpperLimit=3)[0].values
...
try:
  windprobgt30 = grbs.select(name='10 metre wind speed',typeOfLevel='heightAboveGround',level=10,productDefinitionTemplateNumber=5,scaledValueOfUpperLimit=15400,scaleFactorOfUpperLimit=3)[0].values
  print 'max windprobgt30:', np.max(windprobgt30)
except:
  print 'no windprobgt30'
  windprobgt30=None

try:
  windsheargt30 = grbs.select(name='Vertical speed shear',productDefinitionTemplateNumber=5,scaledValueOfUpperLimit=15400,scaleFactorOfUpperLimit=3)[0].values
#  windsheargt30 = grbs.select(name='Vertical speed shear',typeOfLevel='heightAboveGround',topLevel=6000,bottomLevel=0,productDefinitionTemplateNumber=5,scaledValueOfUpperLimit=15400,scaleFactorOfUpperLimit=3)[0].values
  print 'max windsheargt30:', np.max(windsheargt30)
except:
  print 'no windsheargt30'
  windsheargt30=None
  

try:
  vis800 = grbs.select(name='Visibility',productDefinitionTemplateNumber=5,scaledValueOfLowerLimit=800000,scaleFactorOfLowerLimit=3)[0].values
  print 'max vis800:', np.max(vis800)
except:
  vis800=None

try:
  vis3200 = grbs.select(name='Visibility',productDefinitionTemplateNumber=5,scaledValueOfLowerLimit=3200000,scaleFactorOfLowerLimit=3)[0].values
  print 'max vis3200:', np.max(vis3200)
except:
  vis3200=None


try:
  vis = grbs.select(name='Visibility',productDefinitionTemplateNumber=2)[0].values
  print 'max vis:', np.max(vis)
except:
  vis=None

try:
  pwat = grbs.select(name='Precipitable water',productDefinitionTemplateNumber=2)[0].values
  print 'max pwat:', np.max(pwat)
except:
  pwat=None

try:
  pwat37p5 = grbs.select(name='Precipitable water',productDefinitionTemplateNumber=5,scaledValueOfUpperLimit=37500,scaleFactorOfUpperLimit=3)[0].values
  print 'max pwat37p5:', np.max(pwat37p5)
except:
  pwat37p5=None

try:
  pwat50p0 = grbs.select(name='Precipitable water',productDefinitionTemplateNumber=5,scaledValueOfUpperLimit=50000,scaleFactorOfUpperLimit=3)[0].values
  print 'max pwat50p0:', np.max(pwat50p0)
except:
  pwat50p0=None


try:
  ceil915 = grbs.select(name='Geopotential Height',productDefinitionTemplateNumber=5,scaledValueOfLowerLimit=915000,scaleFactorOfLowerLimit=3)[0].values
  print 'max ceil915:', np.max(ceil915)
except:
  print 'no ceil915'
  ceil915=None
...
try:
  td2mgt291 = grbs.select(stepType='instant',name='2 metre dewpoint temperature',typeOfLevel='heightAboveGround',level=2,productDefinitionTemplateNumber=5,scaledValueOfUpperLimit=291480,scaleFactorOfUpperLimit=3)[0].values
  print 'min/max td2mgt291: ', np.min(td2mgt291), np.max(td2mgt291)
except:
  td2mgt291=None
...
try:
  etopgt10000=grbs.select(stepType='instant',parameterCategory=16,parameterName="197",level=0,productDefinitionTemplateNumber=5,scaledValueOfUpperLimit=10000000,scaleFactorOfUpperLimit=3)[0].values
  print 'etopgt10000 max and min:',np.max(etopgt10000),np.min(etopgt10000)
except:
  etopgt10000=None

try:
  etopgt10668=grbs.select(stepType='instant',parameterCategory=16,parameterName="197",level=0,productDefinitionTemplateNumber=5,scaledValueOfUpperLimit=10668000,scaleFactorOfUpperLimit=3)[0].values
  print 'etopgt10668 max and min:',np.max(etopgt10668),np.min(etopgt10668)
except:
  etopgt10668=None

try:
  etopgt9144=grbs.select(stepType='instant',parameterCategory=16,parameterName="197",level=0,productDefinitionTemplateNumber=5,scaledValueOfUpperLimit=9144000,scaleFactorOfUpperLimit=3)[0].values
  print 'etopgt9144 max and min:',np.max(etopgt9144),np.min(etopgt9144)
except:
  etopgt9144=None
...
# cat 16
    print('loop for etop')
    etop=grbs.select(stepType='instant',parameterCategory=16,parameterName="197",level=0,productDefinitionTemplateNumber=2)[0].values*3.28084 #convert meters to feet
...
#mptest    m.fillcontinents(color='#ddaa66', lake_color='#7777ff', zorder = 0)
    ...
    if dbz is not None:
      ...
      subprocess.call(['rm','href_refc_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#      cs = m.contourf(lons,lats,etop,clevs,colors=colors,latlon=True,extend='max')
      ...
      subprocess.call(['rm','href_etop_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#--------------------------------------------------------------------------------------------
    if csnow is not None and core is 'PROB':
      ...
      # Clear off old plottables but keep all the map info
       ...
       subprocess.call(['rm','href_csnow_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)
       print("%.3f seconds to plot csnow for: "+dom) % t3

    if crain is not None and core is 'PROB':
       t1=time.clock()
      ...
      # Clear off old plottables but keep all the map info
       ...
       subprocess.call(['rm','href_crain_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)
       print("%.3f seconds to plot crain for: "+dom) % t3

    if cicep is not None and core is 'PROB':
       t1=time.clock()
      ...
      # Clear off old plottables but keep all the map info
       ...
       subprocess.call(['rm','href_cicep_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)
       print("%.3f seconds to plot cicep for: "+dom) % t3

    if cfzr is not None and core is 'PROB':
       t1=time.clock()
      ...
      # Clear off old plottables but keep all the map info
       ...
       subprocess.call(['rm','href_cfzr_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
    ...
    if apcp6h is not None and core is not 'PROB':
      #Now plot apcp6h
...
#       cm=plt.get_cmap(name='gist_ncar')
       ...
       subprocess.call(['rm','href_apcp6h_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    ...
    if apcp1h is not None and core is not 'PROB':
...
#       cm=plt.get_cmap(name='gist_ncar')
       ...
       subprocess.call(['rm','href_apcp1h_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    ...
    if snow1h is not None and core is 'MEAN':
...
#--------------------------------------------------------------------------------------------
    ...
    if snow3h is not None and core is 'MEAN':
...
#       cm=plt.get_cmap(name='gist_ncar')
       ...
       subprocess.call(['rm','href_apcp12h_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#------------------------------------
    ...
    if apcp24h is not None and core is not 'PROB':
      ...
      #Now plot apcp24h
       ...
       subprocess.call(['rm','href_apcp24h_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#------------------------------------
    if apcp36h is not None and core is 'PROB':
      ...
      #Now plot apcp36h
       ...
       clevs = [0.01,0.10,0.25,0.50,0.75,1.00,1.50,2.00,2.50,3.00,4.00,6.00,8.00,10.00,15.0,20.0]
       cm = c.ListedColormap(pcolors)
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       ...
       subprocess.call(['rm','href_apcp36h_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if cape is not None and core is 'MEAN':
      ...
      #Now plot apcp3h
       clevs = [0.01,0.05,0.10,0.25,0.50,0.75,1.00,1.50,2.00,2.50,3.00,4.00,5.00,6.00,7.00,10.0]
       clevs = [250.,500.,750.,1000.,1250.,1500.,1750.,2000.,2250.,2500.,2750.,3000.,3500.,4000.,4500.,5000.]
       cm = c.ListedColormap(pcolors)
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,cape,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(250.,10000.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('J/kg')
       plt.title(domid+core+' Mean ML CAPE \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_cape_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_cape_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_cape_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_cape_'+dom+'_f'+fhr+'_'+domid+core+'.png'])


       t2 = time.clock()
       t3=round(t2-t1, 3)
       print("%.3f seconds to plot APCP3h for: "+dom) % t3
    if apcp3h is not None and core is not 'PROB':
      ...
      #Now plot apcp3h
       ...
       subprocess.call(['rm','href_apcp3h_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------------------
    ...
    if apcp3hb is not None:
      ...
      #Now plot apcp3hb
       ...
       plt.savefig('./href_apcp3h_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_apcp3h_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_apcp3h_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_apcp3hb_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#------------------------------
    ...
    if apcp6hb is not None:
      ...
      #Now plot apcp6hb
       ...
       plt.savefig('./href_apcp6h_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_apcp6h_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_apcp6h_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_apcp6hb_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if onekmrefdprob40 is not None and core is 'PROB':
      # Get the next plot ready instantaneous onekmrefdprob40
       t1=time.clock()
      ...
      #Now plot onekmrefdprob40
       ...
       subprocess.call(['rm','href_onekmrefdprob40_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if mx1kmrefdprob40 is not None and core is 'PROB':
      # Get the next plot ready instantaneous onekmrefdprob40
       t1=time.clock()
      ...
      #Now plot mx1kmrefdprob40
       ...
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' 1 km prob mxrefd > 40 dBZ  \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       ...
       subprocess.call(['rm','href_mx1kmrefdprob40_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)

#--------------------------------------------------------------------------------------------
    if refcgt50 is not None and core is 'PROB':
      # Get the next plot ready instantaneous refcgt50
       t1=time.clock()
       print('Working on REFCGT50 for '+dom)
      ...
      #Now plot mx1kmrefdprob40
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,refcgt50,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' refc > 50 dBZ  \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_refcgt50_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_refcgt50_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_refcgt50_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_refcgt50_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)
#--------------------------------------------------------------------------------------------
    if firewx is not None and core is 'PROB':
      # Get the next plot ready instantaneous firewx 
       t1=time.clock()
       print('Working on FIREWX for '+dom)
      ...
      #Now plot firewx
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,firewx,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' RH < 20% AND 10 m wind > 17.5 kt  \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_firewx_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_firewx_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_firewx_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_firewx_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)
       print("%.3f seconds to plot firewx for: "+dom) % t3

#--------------------------------------------------------------------------------------------
    if cape500 is not None and core is 'PROB':
      # Get the next plot ready instantaneous onekmrefdprob40
       t1=time.clock()
       print('Working on CAPE500 for '+dom)
      ...
      #Now plot cape500
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,cape500,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' ML CAPE  > 500 J/kg  \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_capegt500_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_capegt500_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_capegt500_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_capegt500_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)
       print("%.3f seconds to plot cape500 for: "+dom) % t3
#--------------------------------------------------------------------------------------------
    if cape1000 is not None and core is 'PROB':
      # Get the next plot ready instantaneous onekmrefdprob40
       t1=time.clock()
       print('Working on CAPE1000 for '+dom)
      ...
      #Now plot cape1000
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,cape1000,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' ML CAPE  > 1000 J/kg  \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_capegt1000_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_capegt1000_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_capegt1000_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_capegt1000_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)
       print("%.3f seconds to plot cape1000 for: "+dom) % t3

#--------------------------------------------------------------------------------------------

    if cape2000 is not None and core is 'PROB':
      # Get the next plot ready instantaneous onekmrefdprob40
       t1=time.clock()
       print('Working on CAPE2000 for '+dom)
      ...
      #Now plot cape2000
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,cape2000,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' ML CAPE  > 2000 J/kg  \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_capegt2000_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_capegt2000_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_capegt2000_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_capegt2000_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)
       print("%.3f seconds to plot cape2000 for: "+dom) % t3

#--------------------------------------------------------------------------------------------

    if cape3000 is not None and core is 'PROB':
      # Get the next plot ready instantaneous onekmrefdprob40
       t1=time.clock()
       print('Working on CAPE3000 for '+dom)
      ...
      #Now plot cape3000
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,cape3000,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' ML CAPE  > 3000 J/kg  \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_capegt3000_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_capegt3000_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_capegt3000_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_capegt3000_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)
       print("%.3f seconds to plot cape3000 for: "+dom) % t3

#--------------------------------------------------------------------------------------------

    if lifr is not None and core is 'PROB':
...
#--------------------------------------------------------------------------------------------
    ...
    if ifr is not None and core is 'PROB':
...
#--------------------------------------------------------------------------------------------
    ...
    if mvfr is not None and core is 'PROB':
...
#--------------------------------------------------------------------------------------------
    ...
    if vfr is not None and core is 'PROB':
...
#--------------------------------------------------------------------------------------------
    if vis800 is not None and core is 'PROB':
      ...
      #Now plot vis800
       ...
       subprocess.call(['rm','href_vis800_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)

    if vis3200 is not None and core is 'PROB':
      # Get the next plot ready instantaneous vis3200
       t1=time.clock()
       print('Working on VIS3200 for '+dom)
      ...
      #Now plot vis3200
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,vis3200,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' prob visibility < 3200 m  \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_vis3200_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_vis3200_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_vis3200_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_vis3200_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
## HERE
    if vis is not None and core is 'MEAN':
      ...
      #Now plot vis
       clevs = [0.,300.,600.,900.,1200.,1500.,1800.,2100.,2500.,3000.,4000.,5000.,6000.,8000.,10000.,15000.]
       cm = c.ListedColormap(pcolors)
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       ...
       plt.savefig('./href_vis_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_vis_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_vis_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_vis_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    ...
    if pwat is not None and core is 'MEAN':
      ...
      #Now plot pwat
       ...
       plt.savefig('./href_pwat_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_pwat_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_pwat_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_pwat_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if td2mgt291 is not None and core is 'PROB':
      # Get the next plot ready instantaneous td2mgt291
       t1=time.clock()
       print('Working on TD2MGT291 for '+dom)
      ...
      #Now plot td2mgt291
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,td2mgt291,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' prob 2 m Td > 65 F \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_td2mgt291_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_td2mgt291_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_td2mgt291_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_td2mgt291_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)

#--------------------------------------------------------------------------------------------
    if td2mgt285 is not None and core is 'PROB':
      ...
      #Now plot td2mgt285
       ...
       subprocess.call(['rm','href_td2mgt285_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if ceil915 is not None and core is 'PROB':
      # Get the next plot ready instantaneous ceil915
       t1=time.clock()
       print('Working on CEIL915 for '+dom)
      ...
      #Now plot ceil915
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,ceil915,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' prob ceiling height < 3000 ft  \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_ceil915_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_ceil915_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_ceil915_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_ceil915_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)

#--------------------------------------------------------------------------------------------
    if ceil610 is not None and core is 'PROB':
      ...
      #Now plot ceil610
       ...
       subprocess.call(['rm','href_ceil610_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)

#--------------------------------------------------------------------------------------------
    if ceil305 is not None and core is 'PROB':
      ...
      #Now plot ceil305
       ...
       subprocess.call(['rm','href_ceil305_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)

#--------------------------------------------------------------------------------------------
    if pwat37p5 is not None and core is 'PROB':
      # Get the next plot ready instantaneous pwat37pt
       t1=time.clock()
       print('Working on PWAT37P5 for '+dom)
      ...
      #Now plot pwat37p5
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,pwat37p5,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' prob precipitable water > 1.5"  \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_pwat37p5_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_pwat37p5_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_pwat37p5_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_pwat37p5_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)

#--------------------------------------------------------------------------------------------
    if pwat50p0 is not None and core is 'PROB':
      # Get the next plot ready instantaneous pwat50pt0
       t1=time.clock()
       print('Working on PWAT50P0 for '+dom)
      ...
      #Now plot pwat50p0
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,pwat50p0,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' prob precipitable water > 2.0"  \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_pwat50p0_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_pwat50p0_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_pwat50p0_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_pwat50p0_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if mxuphlprob25 is not None and core is 'PROB':
      ...
      #Now plot 
       ...
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' 2-5 km prob MXUPHL > 25 m^2 s^-2  \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       ...
       subprocess.call(['rm','href_mxuphlprob25_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)

#--------------------------------------------------------------------------------------------
    if mxuphlprob100 is not None and core is 'PROB':
      # Get the next plot ready
       t1=time.clock()
       print('Working on MXUPHLPROB100 for '+dom)
      ...
      #Now plot 
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,mxuphlprob100,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' 2-5 km prob MXUPHL > 100 m^2 s^-2  \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_mxuphlprob100_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_mxuphlprob100_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_mxuphlprob100_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_mxuphlprob100_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
#--------------------------------------------------------------------------------------------
    if uphlprob25 is not None and core is 'PROB':
      # Get the next plot ready
       t1=time.clock()
       print('Working on UPHLPROB25 for '+dom)
      ...
      #Now plot 
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,uphlprob25,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' 2-5 km prob UPHL > 25 m^2 s^-2  \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_uphlprob25_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_uphlprob25_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_uphlprob25_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_uphlprob25_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)

#--------------------------------------------------------------------------------------------
    if uphlprob100 is not None and core is 'PROB':
      # Get the next plot ready
       t1=time.clock()
       print('Working on UPHLPROB100 for '+dom)
      ...
      #Now plot 
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,uphlprob100,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+'  2-5 km prob UPHL > 100 m^2 s^-2  \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_uphlprob100_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_uphlprob100_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_uphlprob100_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_uphlprob100_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
## combo ptype
    ...
    if ptype is not None:
       ...
       print 'here '
       t1=time.clock()
       print('Working on ptype_alt for '+dom)
       # Clear off old plottables but keep all the map info
       ncepy.clear_plotables(ax,keep_ax_lst,fig)
       ...
       cs = m.pcolormesh(lons,lats,crain,cmap=cm2,vmin=0.51,vmax=1.,latlon=True)
       cs = m.pcolormesh(lons,lats,cicep,cmap=cm4,vmin=0.51,vmax=1.,latlon=True)
       cs = m.pcolormesh(lons,lats,cfzr,cmap=cm3,vmin=0.51,vmax=1.,latlon=True)
       cs = m.pcolormesh(lons,lats,csnow,cmap=cm,vmin=0.51,vmax=1.,latlon=True)
       ...
       subprocess.call(['rm','href_ptypemean_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
       t2 = time.clock()
       t3=round(t2-t1, 3)
       print("%.3f seconds to plot ptype_alt "+dom) % t3

## end combo ptype

    if t2mprob273 is not None and core is 'PROB':
      # Get the next plot ready
       t1=time.clock()
      ...
      #Now plot 
       ...
       subprocess.call(['rm','href_t2mprob273_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)

#--------------------------------------------------------------------------------------------
    if windprobgt20 is not None and core is 'PROB':
      # Get the next plot ready
       t1=time.clock()
      ...
      #Now plot 
       ...
       subprocess.call(['rm','href_windprobgt20_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)

#--------------------------------------------------------------------------------------------
    if windprobgt30 is not None and core is 'PROB':
      # Get the next plot ready
       t1=time.clock()
       print('Working on WINDPROBGT30'+dom)
      ...
      #Now plot 
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,windprobgt30,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' 10 m WIND SPEED > 30 kt \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_windprobgt30_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_windprobgt30_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_windprobgt30_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_windprobgt30_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)

#--------------------------------------------------------------------------------------------
    if windsheargt30 is not None and core is 'PROB':
      # Get the next plot ready
       t1=time.clock()
       print('Working on WINDSHEARGT30'+dom)
      ...
      #Now plot 
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,windsheargt30,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' 0-6000 m AGL Shear > 30 kt \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_windsheargt30_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_windsheargt30_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_windsheargt30_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_windsheargt30_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)

#--------------------------------------------------------------------------------------------    
    if meanshear is not None and core is 'MEAN':
      # Get the next plot ready mean shear
       t1=time.clock()
       print('Working on meanshear for '+dom)   
      ...
      #Now plot meanshear
       ...
       cs = m.contourf(lons,lats,ncepy.ms2kts(meanshear),clevs,cmap=plt.get_cmap(name='Paired'),latlon=True,extend='max')
       cs.set_clim(10,70) 
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs)
       cbar.set_label('kts')
       cbar.ax.tick_params(labelsize=8.5) 
      #plot contours too
       ...
       plt.title(domid+core+' Mean 0-6 km AGL shear (kt) \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
  
       plt.savefig('./href_meanshear_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_meanshear_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_meanshear_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
  
       t2 = time.clock()
       t3=round(t2-t1, 3)
       print("%.3f seconds to plot meanshear for: "+dom) % t3	   

#--------------------------------------------------------------------------------------------
    if etopgt10668 is not None and core is 'PROB':
      # Get the next plot ready
       t1=time.clock()
       print('Working on ETOPGT10668 '+dom)
      ...
      #Now plot 
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,etopgt10668,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' Prob Echo Top height > ~35K feet \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_etopgt10668_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_etopgt10668_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_etopgt10668_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_etopgt10668_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)

#--------------------------------------------------------------------------------------------
    if etopgt9144 is not None and core is 'PROB':
      # Get the next plot ready
       t1=time.clock()
       print('Working on ETOPGT9144 '+dom)
      ...
      #Now plot 
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,etopgt9144,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' Prob Echo Top height > ~30K feet \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_etopgt9144_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_etopgt9144_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_etopgt9144_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_etopgt9144_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ---------------------------------
    ...
    if apcp3hp254 is not None and core is 'PROB':
      # Get the next plot ready instantaneous APCP3H
       t1=time.clock()
      ...
      #Now plot apcp3hp254
       ...
       subprocess.call(['rm','href_apcp3hp254_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if apcp3h12p4 is not None:
      ...
      #Now plot apcp3h12p4
       ...
       subprocess.call(['rm','href_apcp3h12p4_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if sn3h1inch is not None:
      ...
      #Now plot sn3h1inch
       ...
       subprocess.call(['rm','href_sn3h1inch_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if sn1h1inch is not None:
      ...
      #Now plot sn1h1inch
       ...
       subprocess.call(['rm','href_sn1h1inch_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if sn3h3inch is not None:
      ...
      #Now plot sn3h3inch
       ...
       subprocess.call(['rm','href_sn3h3inch_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if apcp3h12p7 is not None:
      ...
      #Now plot apcp3h12p7
       ...
       subprocess.call(['rm','href_apcp3h12p7_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if apcp1h12p7 is not None:
      ...
      #Now plot apcp1h12p7
       ...
       subprocess.call(['rm','href_apcp1h12p7_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if apcp3h25p1 is not None:
      ...
      #Now plot apcp3h25p1
       ...
       subprocess.call(['rm','href_apcp1h25p1_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
    ...
    if apcp3h25p4 is not None:
      ...
      #Now plot apcp3h25p4
       ...
       subprocess.call(['rm','href_apcp3h25p4_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if apcp3hffg3 is not None:
      ...
      #Now plot apcp3hffg3
       ...
       subprocess.call(['rm','href_apcp3hffg3_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if apcp3hffg4 is not None:
      ...
      #Now plot apcp3hffg4
       ...
       subprocess.call(['rm','href_apcp3hffg4_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
# ----------
    ...
    if apcp6hffg6 is not None:
      ...
      #Now plot apcp6hffg6
       ...
       subprocess.call(['rm','href_apcp6hffg6_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)
       print("%.3f seconds to plot APCP6hffg6  for: "+dom) % t3

    if apcp6hri5 is not None:
      # Get the next plot ready instantaneous APCP6H
       t1=time.clock()
       print('Working on APCP6HRI5 for '+dom)
      ...
      #Now plot apcp6hri5
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,apcp6hri5,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' 6h APCP > 5 yr RI  \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_apcp6hri5_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_apcp6hri5_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_apcp6hri5_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_apcp6hri5_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)
       print("%.3f seconds to plot APCP6hri5  for: "+dom) % t3

    if apcp6hri50 is not None:
      # Get the next plot ready instantaneous APCP6H
       t1=time.clock()
       print('Working on APCP6HRI50 for '+dom)
      ...
      #Now plot apcp6hri50
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,apcp6hri50,clevs,cmap=cm,norm=norm,latlon=True)
       cs.set_clim(1.0,100.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('probability')
       plt.title(domid+core+' 6h APCP > 50 yr RI  \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./href_apcp6hri50_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'href_apcp6hri50_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'href_apcp6hri50_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','href_apcp6hri50_'+dom+'_f'+fhr+'_'+domid+core+'.png'])

       t2 = time.clock()
       t3=round(t2-t1, 3)
       print("%.3f seconds to plot APCP6hri50  for: "+dom) % t3
...
#---------------------------------------------------------------------------------------------    
    ...
    #Now plot REFC dBZ
      ...
      subprocess.call(['rm','href_mx1kmrefd_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#      clab = plt.clabel(cs,clevs[::3],inline=1, fontsize=10,fmt='%.0f')
      ...
      subprocess.call(['rm','href_mxuphl_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------    
      ...
      subprocess.call(['rm','href_gust_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#      clab = plt.clabel(cs,clevs[::3],inline=1, fontsize=10,fmt='%.0f')
      ...
      subprocess.call(['rm','href_uphl_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------    
    ...
    if onekmrefd is not None and core is 'PMMN':
      ...
      subprocess.call(['rm','href_1kmrefd_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#-   -------------------------------------------------------------------------------------------    
     ...
     t1=time.clock()
     if t2m is not None and core is 'MEAN':
      print('Working on 2mt for '+dom)   
      
      # Clear off old plottables but keep all the map info
      ncepy.clear_plotables(ax,keep_ax_lst,fig)

      clevs = np.arange(-24.,48.,3)
      ...
      subprocess.call(['rm','href_2mtw_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#-   -------------------------------------------------------------------------------------------    
     ...
     if td2m is not None and core is 'MEAN':
      t1=time.clock()
...
#      m.barbs(lons[::skip,::skip],lats[::skip,::skip],u10[::skip,::skip],v10[::skip,::skip],latlon=True,length=5.5,sizes={'spacing':0.2},pivot='middle')
      ...
      subprocess.call(['rm','href_2mtdw_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
      t2 = time.clock()
      t3=round(t2-t1, 3)
