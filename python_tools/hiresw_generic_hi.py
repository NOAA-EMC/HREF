...
#--------------------------------------------------------------------------------------------
    if refcgt50 is not None:
      ...
      #Now plot mx1kmrefdprob40
       ...
       plt.savefig('./hiresw_refcgt50_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'hiresw_refcgt50_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'hiresw_refcgt50_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','hiresw_refcgt50_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if cape500 is not None:
      ...
      #Now plot cape500
       ...
       plt.savefig('./hiresw_capegt500_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'hiresw_capegt500_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'hiresw_capegt500_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','hiresw_capegt500_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if cape1000 is not None:
      ...
      #Now plot cape1000
       ...
       plt.savefig('./hiresw_capegt1000_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'hiresw_capegt1000_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'hiresw_capegt1000_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','hiresw_capegt1000_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    ...
    if cape2000 is not None:
      ...
      #Now plot cape2000
       ...
       plt.savefig('./hiresw_capegt2000_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'hiresw_capegt2000_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'hiresw_capegt2000_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','hiresw_capegt2000_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    ...
    if cape3000 is not None:
      ...
      #Now plot cape3000
       ...
       plt.savefig('./hiresw_capegt3000_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
       subprocess.call(['convert','-density', '100x100', 'hiresw_capegt3000_'+dom+'_f'+fhr+'_'+domid+core+'.png', 'hiresw_capegt3000_'+dom+'_f'+fhr+'_'+domid+core+'.gif'])
       subprocess.call(['rm','hiresw_capegt3000_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#--------------------------------------------------------------------------------------------
    if vis800 is not None:
      ...
      #Now plot vis800
       ...
       subprocess.call(['rm','hiresw_vis800_'+dom+'_f'+fhr+'_'+domid+core+'.png'])
...
#-   -------------------------------------------------------------------------------------------    
     ...
     if td2m is not None:
      ...
      m.barbs(lons[::skip,::skip],lats[::skip,::skip],u10mx[::skip,::skip],v10mx[::skip,::skip],latlon=True,length=5.5,sizes={'spacing':0.2},pivot='middle')
