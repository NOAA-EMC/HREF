...
if __name__ == '__main__':
  ...
  precip1 = f1.select(name='Total Precipitation',lengthOfTimeRange=6)[0].values
  ...
  msg7=f7.select(name='Total Precipitation',lengthOfTimeRange=6)[0] #store grib msg 
  precip7 = msg7.values 

  msg8=f8.select(name='Total Precipitation',lengthOfTimeRange=6)[0] #store grib msg 
  precip8 = msg8.values 
