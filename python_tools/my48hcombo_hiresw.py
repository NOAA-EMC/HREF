...
#  grbmsg_out.product_definition_template[28]=int(frange)
#  #Set the correct valid time (end of the range window
#  grbmsg_out.product_definition_template[17]=int(yyyy) #year
#  grbmsg_out.product_definition_template[18]=int(mm)   #month 
#  grbmsg_out.product_definition_template[19]=int(dd)   #day
#  grbmsg_out.product_definition_template[20]=int(hh)   #hour
...
if __name__ == '__main__':
  ...
  gb7=config.get("myvars", "gb7")
  gb8=config.get("myvars", "gb8")
  ...
  msg1=f1.select(name='Total Precipitation')[0]
  precip1 = msg1.values

  msg2=f2.select(name='Total Precipitation')[0] #store grib msg 
  precip2 = msg2.values 

  msg3=f3.select(name='Total Precipitation')[0] #store grib msg 
  precip3 = msg3.values 

  msg4=f4.select(name='Total Precipitation')[0] #store grib msg 
  precip4 = msg4.values 

  msg5=f5.select(name='Total Precipitation')[0] #store grib msg 
  precip5 = msg5.values 

  msg6=f6.select(name='Total Precipitation')[0] #store grib msg 
  precip6 = msg6.values 

  msg7=f7.select(name='Total Precipitation')[0] #store grib msg 
  precip7 = msg7.values 

  msg8=f8.select(name='Total Precipitation')[0] #store grib msg 
  precip8 = msg8.values 

  print('Adding!')
  precip_out = precip1+precip2+precip3+precip4+precip5+precip6+precip7+precip8
  ...
  print 'frange: ', frange
  print 'yyyy mm dd hh: ', yyyy, mm, dd, hh
  print 'startfhr: ', startfhr
