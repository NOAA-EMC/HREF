...
export NDATE=/gpfs/hps/nco/ops/nwprod/prod_util.v1.0.13/exec/ndate
...
rm oldcycs_akhiresw.html
rm oldcycs_conushiresw.html
...
for  dom in $doms
do
cat oldcycs2.html_innew_00_06_${dom}hiresw | sed s:_DATEM0_:${DATEM0}:g | sed s:_MMDD0_:${MMDD0}:g  \
                     ...
                     | sed s:_DATEM6_:${DATEM6}:g | sed s:_MMDD6_:${MMDD6}:g  > oldcycs_${dom}hiresw.html
done
...
cat oldcycs2.html_innew_12_18_${dom}hiresw | sed s:_DATEM0_:${DATEM0}:g | sed s:_MMDD0_:${MMDD0}:g  \
                     | sed s:_DATEM1_:${DATEM1}:g | sed s:_MMDD1_:${MMDD1}:g  \
                     | sed s:_DATEM2_:${DATEM2}:g | sed s:_MMDD2_:${MMDD2}:g  \
                     | sed s:_DATEM3_:${DATEM3}:g | sed s:_MMDD3_:${MMDD3}:g  \
                     | sed s:_DATEM4_:${DATEM4}:g | sed s:_MMDD4_:${MMDD4}:g  \
...
scp oldcycs_*hiresw.html mpyle@emcrzdm.ncep.noaa.gov:/home/www/emc/htdocs/mmb/mpyle/hiresw/
