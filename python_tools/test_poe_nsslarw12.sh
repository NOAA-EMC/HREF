...
#BSUB -oo /meso/save/Matthew.Pyle/spcprodlike/jobs/test_graphics.out_pyth_nssl_12
#BSUB -eo /meso/save/Matthew.Pyle/spcprodlike/jobs/test_graphics.err_pyth_nssl_12
#BSUB -R span[ptile=9]
#BSUB -x
#BSUB -P HRW-T2O
...
${base}/test_precip_add.sh_12_nssl
...
for hr in $hrs
do 
echo "python plt_grib2_nsslwrf_test.py /gpfs/hps/ptmp/Matthew.Pyle/com/hiresw/test/hiresw.${PDY}/hiresw.t${cyc}z.arw_5km.f${hr}.conusnssl.grib2 CONUS nsslarw" >> poe.script
done
