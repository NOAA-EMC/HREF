...
#mptest    m.fillcontinents(color='#ddaa66', lake_color='#7777ff', zorder = 0)
    ...
    outfile='./conusarw_slp_'+dom+'_f'+fhr+'_'+domid+core+'.png'
...
#    plt.savefig(outfile)
    ...
    if dbz is not None:
      ...
      plt.savefig('./conusarw_refc_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#      cs = m.contourf(lons,lats,etop,clevs,colors=colors,latlon=True,extend='max')
      ...
      plt.savefig('./conusarw_etop_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#---------------------------------------------------------------------------------------------    
    ...
    #Now plot REFC dBZ
      ...
      plt.savefig('./conusarw_mx1kmrefd_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      clab = plt.clabel(cs,clevs[::3],inline=1, fontsize=10,fmt='%.0f')
      ...
      plt.savefig('./conusarw_mxuphl_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      clab = plt.clabel(cs,clevs[::3],inline=1, fontsize=10,fmt='%.0f')
      ...
      plt.savefig('./conusarw_max10mw_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#--------------------------------------------------------------------------------------------    
      ...
      plt.savefig('./conusarw_gust_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      clab = plt.clabel(cs,clevs[::3],inline=1, fontsize=10,fmt='%.0f')
      ...
      plt.savefig('./conusarw_uphl_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#       cm=plt.get_cmap(name='gist_ncar')
       ...
       plt.savefig('./conusarw_apcp3h_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#       cm=plt.get_cmap(name='gist_ncar')
       ...
       plt.savefig('./conusarw_apcp6h_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#--------------------------------------------------------------------------------------------    
      ...
      #Now plot apcp48h
       ...
       plt.savefig('./conusarw_apcp48h_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      clab = plt.clabel(cs,clevs[::3], inline=1, fontsize=10,fmt='%.0f')
      ...
      plt.savefig('./conusarw_maxvvel_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      clab = plt.clabel(cs,clevs[::3], inline=1, fontsize=10,fmt='%.0f')
      ...
      plt.savefig('./conusarw_maxdvvel_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#--------------------------------------------------------------------------------------------    
    if onekmrefd is not None:
      ...
      plt.savefig('./conusarw_1kmrefd_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight') 
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#-   -------------------------------------------------------------------------------------------    
      ...
      plt.savefig('./conusarw_sbcape_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
# print min/max sbcinh vals
      ...
      plt.savefig('./conusarw_sbcinh_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#     	t.set_bbox(dict(boxstyle="square",fc="white"))
      ...
      plt.savefig('./conusarw_2mtw_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#          t.set_bbox(dict(boxstyle="square",fc="white"))
        ...
        plt.savefig('./conusarw_lowestmodlevt_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
        t2 = time.clock()
        t3=round(t2-t1, 3)
...
#     	t.set_bbox(dict(boxstyle="square",fc="white"))
      ...
      plt.savefig('./conusarw_tskin_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#      plt.savefig('./conusarw_soilm0-10_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusarw_soilm10-40_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusarw_soilm40-100_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
#
      # Clear off old plottables but keep all the map info
      ncepy.clear_plotables(ax,keep_ax_lst,fig)
...
#       plt.savefig('./conusarw_soilm100-200_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusarw_soilfz0-10_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusarw_soilfz10-40_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusarw_soilfz40-100_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusarw_soilfz100-200_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusarw_tsoil0-10_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusarw_tsoil10-40_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
###
#      # Clear off old plottables but keep all the map info
#      ncepy.clear_plotables(ax,keep_ax_lst,fig)
...
#      plt.savefig('./conusarw_tsoil40-100_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusarw_tsoil100-200_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      m.barbs(lons[::skip,::skip],lats[::skip,::skip],u10[::skip,::skip],v10[::skip,::skip],latlon=True,length=5.5,sizes={'spacing':0.2},pivot='middle')
      ...
      plt.savefig('./conusarw_2mtdw_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#    Now plot the radiation fields
      ...
      if gdhfx is not None:
        ...
        plt.savefig('./conusarw_ghflux_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusarw_netrad_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      ...
      plt.savefig('./conusarw_lhfx_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusarw_snhfx_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusarw_swdown_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      ...
      if clearskydownswfx is not None:
        ...
        plt.savefig('./conusarw_clearskydownswfx_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusarw_swup_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusarw_lwup_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusarw_lwdown_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#    ------------DONE WITH RADIATION FIELDS ----------------------------------------------
  ...
  #End of analysis diag skip
    ...
    if tqw is not None:
      ...
      plt.savefig('./conusarw_tqw_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
    ...
    if tqr is not None:
      ...
      plt.savefig('./conusarw_tqr_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
    ...
    if tqi is not None:
      ...
      plt.savefig('./conusarw_tqi_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
    ...
    if tqs is not None:
      ...
      plt.savefig('./conusarw_tqs_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
    ...
    if tcwmr is not None:
      ...
      plt.savefig('./conusarw_tcwmr_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
    ...
    if tqsld is not None:
      ...
      ax.annotate(msg,xy=(0.5,0.025),xycoords='axes fraction',color='k',zorder=10,
             fontsize=10,ha='center', va='center',bbox=dict(fc="white"))
      plt.savefig('./conusarw_tqsld_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
    ...
    if tqshd is not None:
      ...
      ax.annotate(msg,xy=(0.5,0.025),xycoords='axes fraction',color='k',zorder=10,
             fontsize=10,ha='center', va='center',bbox=dict(fc="white"))
      plt.savefig('./conusarw_tqshd_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#                Cloud Cover
    ...
    if lowcloudcover is not None and midcloudcover is not None and highcloudcover is not None:
      ...
      plt.savefig('./conusarw_low_mid_high_clouds_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      try:
        cbar3.remove()
        cbar2.remove()
        cbar1.remove()
    ...
    if totalcloudcover is not None:
      ...
      plt.savefig('./conusarw_totalcloudcover_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#------Winter Weather Plots--------------------------------------------------------
    if snowdepth is not None:
      ...
      plt.savefig('./conusarw_snowdepth_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
    ...
    if pofp is not None:
      ...
      plt.savefig('./conusarw_pofp_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
    ...
    if ptype is not None:
      ...
      plt.savefig('./conusarw_ptype_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
    ...
    if RF_lev1 is not None and tskin is not None:
      ...
      if dom != 'CONUS' and dom != 'AK':
        ...
        ax.annotate(msg,xy=(0.5,0.025),xycoords='axes fraction',color='k',zorder=10,
               fontsize=10,ha='center', va='center',bbox=dict(fc="white"))
      plt.savefig('./conusarw_lev1RF_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
