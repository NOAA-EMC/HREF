...
def myplt_highs_and_lows(m,mat,lons,lats,mode='wrap',window='10'):
  # From: http://matplotlib.org/basemap/users/examples.html
  # m is the map handle
  x, y = m(lons, lats)
  ...
  for x,y,p in zip(xlows, ylows, lowvals):
    print '(a)m.xmax, m.xmin ', m.xmax, m.xmin
    print '(a)m.ymax, m.ymin ', m.ymax, m.ymin
  ...
  for x,y,p in zip(xhighs, yhighs, highvals):
    print '(b)m.xmax, m.xmin ', m.xmax, m.xmin
    print '(b)m.ymax, m.ymin ', m.ymax, m.ymin
    if x < m.xmax and x > m.xmin and y < m.ymax and y > m.ymin:
        dist = [np.sqrt((x-x0)**2+(y-y0)**2) for x0,y0 in xyplotted]
        if not dist or min(dist) > dmin:
            ...
            plt.text(x,y-yoffset,repr(int(p)),fontsize=9,
                    ha='right',va='top',color='b',zorder=10,
                    bbox = dict(boxstyle="square",ec='None',fc=(1,1,1,0.5)))
            xyplotted.append((x,y))
...
# for g in grbs:
#  print g.name, g.typeOfLevel, g.level
...
try:
 # apcp6h
  apcp6h=grbs.select(stepType='accum',name='Total Precipitation',lengthOfTimeRange=6)[0].values
# convert to inches
  apcp6h=apcp6h/25.4
...
try:
 # apcp48h
  apcp48h=grbs.select(stepType='accum',name='Total Precipitation',lengthOfTimeRange=48)[0].values
...
#  MUCAPE=grbs.select(name="Convective available potential energy",typeOfLevel='pressureFromGroundLayer',level=18000)[0].values  #MUCAPE
  MUCAPE=grbs.select(name="Convective available potential energy",typeOfLevel='pressureFromGroundLayer')[0].values  #MUCAPE
...
#mptest    m.fillcontinents(color='#ddaa66', lake_color='#7777ff', zorder = 0)
    ...
    outfile='./conusnsslarw_slp_'+dom+'_f'+fhr+'_'+domid+core+'.png'
...
#      myplt_highs_and_lows(m,mslp,lons,lats,mode='reflect',window=highslowswindow)

    # plot apcp1h

    if apcp1h is not None:

     clevs = [0.01,0.05,0.10,0.25,0.50,0.75,1.00,1.50,2.00,2.50,3.00,4.00]
...
#    plt.savefig(outfile)
    ...
    if dbz is not None:
      ...
      plt.savefig('./conusnsslarw_refc_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#      cs = m.contourf(lons,lats,etop,clevs,colors=colors,latlon=True,extend='max')
      ...
      plt.savefig('./conusnsslarw_etop_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#---------------------------------------------------------------------------------------------    
    ...
    #Now plot REFC dBZ
      ...
      plt.savefig('./conusnsslarw_mx1kmrefd_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      clab = plt.clabel(cs,clevs[::3],inline=1, fontsize=10,fmt='%.0f')
      ...
      plt.savefig('./conusnsslarw_mxuphl_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      clab = plt.clabel(cs,clevs[::3],inline=1, fontsize=10,fmt='%.0f')
      ...
      plt.savefig('./conusnsslarw_max10mw_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#--------------------------------------------------------------------------------------------    
      ...
      plt.savefig('./conusnsslarw_gust_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      clab = plt.clabel(cs,clevs[::3],inline=1, fontsize=10,fmt='%.0f')
      ...
      plt.savefig('./conusnsslarw_uphl_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#       cm=plt.get_cmap(name='gist_ncar')
       ...
       plt.savefig('./conusnsslarw_apcp3h_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#       cm=plt.get_cmap(name='gist_ncar')
       ...
       plt.savefig('./conusnsslarw_apcp6h_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#--------------------------------------------------------------------------------------------    
      ...
      #Now plot apcp48h
       ...
       cm.set_over('white')
       norm = c.BoundaryNorm(clevs, cm.N)
       cs = m.contourf(lons,lats,apcp48h,clevs,cmap=cm,norm=norm,latlon=True,extend='max')
       cs.set_clim(0.01,10.)
       cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.2f')
       cbar.ax.tick_params(labelsize=8.5)
       cbar.set_label('inches')
       plt.title(domid+core+' 48h APCP \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
       plt.savefig('./conusnsslarw_apcp48h_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      clab = plt.clabel(cs,clevs[::3], inline=1, fontsize=10,fmt='%.0f')
      ...
      plt.savefig('./conusnsslarw_maxvvel_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      clab = plt.clabel(cs,clevs[::3], inline=1, fontsize=10,fmt='%.0f')
      ...
      plt.savefig('./conusnsslarw_maxdvvel_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#--------------------------------------------------------------------------------------------    
    if onekmrefd is not None:
      ...
      plt.savefig('./conusnsslarw_1kmrefd_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight') 
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#-   -------------------------------------------------------------------------------------------    
      ...
      plt.savefig('./conusnsslarw_sbcape_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#-   -------------------------------------------------------------------------------------------    
      ...
      # Get the next plot ready MUCAPE
      t1=time.clock()
      print('Working on cape for '+dom)   
      ...
      clevs = np.arange(250.,5250.,250.)
      cs = m.contourf(lons,lats,MUCAPE,clevs,cmap=plt.get_cmap(name='Spectral_r'),latlon=True,extend='max')
      cs.set_clim(250.,5000.) 
      cbar = m.colorbar(cs,location='bottom',size="2%",pad="5%",ticks=clevs,format='%.0f')
      cbar.ax.tick_params(labelsize=8.5) 
      cbar.set_label('J/kg')
      
      plt.title(domid+core+' MUCAPE \n'+repr(date)+' '+grbtime+'Z cycle Fhr '+fhr+' Valid '+valpdy+' '+valcyc+'00Z')
  
      plt.savefig('./conusnsslarw_mucape_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
# print min/max sbcinh vals
      ...
      plt.savefig('./conusnsslarw_sbcinh_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#     	t.set_bbox(dict(boxstyle="square",fc="white"))
      ...
      plt.savefig('./conusnsslarw_2mtw_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#          t.set_bbox(dict(boxstyle="square",fc="white"))
        ...
        plt.savefig('./conusnsslarw_lowestmodlevt_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
        t2 = time.clock()
        t3=round(t2-t1, 3)
...
#     	t.set_bbox(dict(boxstyle="square",fc="white"))
      ...
      plt.savefig('./conusnsslarw_tskin_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#      plt.savefig('./conusnsslarw_soilm0-10_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusnsslarw_soilm10-40_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusnsslarw_soilm40-100_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
#
      # Clear off old plottables but keep all the map info
      ncepy.clear_plotables(ax,keep_ax_lst,fig)
...
#       plt.savefig('./conusnsslarw_soilm100-200_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusnsslarw_soilfz0-10_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusnsslarw_soilfz10-40_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusnsslarw_soilfz40-100_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusnsslarw_soilfz100-200_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusnsslarw_tsoil0-10_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusnsslarw_tsoil10-40_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
###
#      # Clear off old plottables but keep all the map info
#      ncepy.clear_plotables(ax,keep_ax_lst,fig)
...
#      plt.savefig('./conusnsslarw_tsoil40-100_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusnsslarw_tsoil100-200_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      m.barbs(lons[::skip,::skip],lats[::skip,::skip],u10[::skip,::skip],v10[::skip,::skip],latlon=True,length=5.5,sizes={'spacing':0.2},pivot='middle')
      ...
      plt.savefig('./conusnsslarw_2mtdw_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#    Now plot the radiation fields
      ...
      if gdhfx is not None:
        ...
        plt.savefig('./conusnsslarw_ghflux_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusnsslarw_netrad_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      ...
      plt.savefig('./conusnsslarw_lhfx_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusnsslarw_snhfx_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusnsslarw_swdown_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      ...
      if clearskydownswfx is not None:
        ...
        plt.savefig('./conusnsslarw_clearskydownswfx_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusnsslarw_swup_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusnsslarw_lwup_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
...
#      plt.savefig('./conusnsslarw_lwdown_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#    ------------DONE WITH RADIATION FIELDS ----------------------------------------------
  ...
  #End of analysis diag skip
    ...
    if tqw is not None:
      ...
      plt.savefig('./conusnsslarw_tqw_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
    ...
    if tqr is not None:
      ...
      plt.savefig('./conusnsslarw_tqr_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
    ...
    if tqi is not None:
      ...
      plt.savefig('./conusnsslarw_tqi_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
    ...
    if tqs is not None:
      ...
      plt.savefig('./conusnsslarw_tqs_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
    ...
    if tcwmr is not None:
      ...
      plt.savefig('./conusnsslarw_tcwmr_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
    ...
    if tqsld is not None:
      ...
      ax.annotate(msg,xy=(0.5,0.025),xycoords='axes fraction',color='k',zorder=10,
             fontsize=10,ha='center', va='center',bbox=dict(fc="white"))
      plt.savefig('./conusnsslarw_tqsld_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
    ...
    if tqshd is not None:
      ...
      ax.annotate(msg,xy=(0.5,0.025),xycoords='axes fraction',color='k',zorder=10,
             fontsize=10,ha='center', va='center',bbox=dict(fc="white"))
      plt.savefig('./conusnsslarw_tqshd_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#                Cloud Cover
    ...
    if lowcloudcover is not None and midcloudcover is not None and highcloudcover is not None:
      ...
      plt.savefig('./conusnsslarw_low_mid_high_clouds_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      try:
        cbar3.remove()
        cbar2.remove()
        cbar1.remove()
    ...
    if totalcloudcover is not None:
      ...
      plt.savefig('./conusnsslarw_totalcloudcover_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
...
#------Winter Weather Plots--------------------------------------------------------
    if snowdepth is not None:
      ...
      plt.savefig('./conusnsslarw_snowdepth_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
    ...
    if pofp is not None:
      ...
      plt.savefig('./conusnsslarw_pofp_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
    ...
    if ptype is not None:
      ...
      plt.savefig('./conusnsslarw_ptype_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
    ...
    if RF_lev1 is not None and tskin is not None:
      ...
      if dom != 'CONUS' and dom != 'AK':
        ...
        ax.annotate(msg,xy=(0.5,0.025),xycoords='axes fraction',color='k',zorder=10,
               fontsize=10,ha='center', va='center',bbox=dict(fc="white"))
      plt.savefig('./conusnsslarw_lev1RF_'+dom+'_f'+fhr+'_'+domid+core+'.png',bbox_inches='tight')
      t2 = time.clock()
      t3=round(t2-t1, 3)
