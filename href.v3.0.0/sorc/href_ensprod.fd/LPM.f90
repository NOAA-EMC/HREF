...
SUBROUTINE lpm_mean(nx,ny,n_ens,patch_nx,patch_ny,ovx, ovy, &
...
ipatches=(nx-3)/patch_nx
jpatches=(ny-3)/patch_ny
...
DO ipatch=1, ipatches
    DO jpatch=1, jpatches
        ...
        var2d_lpm(pe_west:pe_east, pe_south:pe_north) =  &
          lpm_calc(offset_i:offset_i + patch_nx, offset_j:offset_j + patch_ny)  
        END IF
