...
!STARTOFREGISTRYGENERATEDINCLUDE 'inc/HALO_CUP_G3_IN.inc'
!
   ...
   cps_select: SELECT CASE(cu_physics)
     ...
     CASE (SASSCHEME)
          ...
          IF ( adapt_step_flag_pass ) THEN
            ...
            CALL wrf_error_fatal3("module_cumulus_driver.b",781,&
wrf_err_message )
          END IF
     ...
     CASE (MESO_SAS)                  
          ...
          IF ( adapt_step_flag_pass ) THEN
            ...
            CALL wrf_error_fatal3("module_cumulus_driver.b",810,&
wrf_err_message )
          END IF
     ...
     CASE (OSASSCHEME)
          ...
          IF ( adapt_step_flag_pass ) THEN
            WRITE( wrf_err_message , * ) 'The SAS cumulus option will not work properly with an adaptive time step'
            CALL wrf_error_fatal3("module_cumulus_driver.b",839,&
wrf_err_message )
          END IF
     ...
     CASE (CAMZMSCHEME)
      ...
      IF(.not.f_qi)THEN
         ...
         CALL wrf_error_fatal3("module_cumulus_driver.b",991,&
wrf_err_message )
      ENDIF
          CALL CAMZM_DRIVER(                                        &
                IDS=ids,IDE=ide,JDS=jds,JDE=jde,KDS=kds,KDE=kde     &
        ...
        ELSE
             ...
             CALL wrf_error_fatal3("module_cumulus_driver.b",1040,&
wrf_err_message )
          ENDIF
     ...
     CASE (TIEDTKESCHEME)
        ...
        ELSE
          CALL wrf_error_fatal3("module_cumulus_driver.b",1074,&
'Lacking arguments for CU_TIEDTKE in cumulus driver')
     ...
     CASE (NSASSCHEME)
        ...
        ELSE
          CALL wrf_error_fatal3("module_cumulus_driver.b",1109,&
'Lacking arguments for CU_NSAS in cumulus driver')
     ...
     CASE DEFAULT 
         ...
         CALL wrf_error_fatal3("module_cumulus_driver.b",1116,&
wrf_err_message )
   ...
   END SELECT cps_select
      ...
      !$OMP END PARALLEL DO
   IF(cu_physics .eq. 5 )then
!STARTOFREGISTRYGENERATEDINCLUDE 'inc/HALO_CUP_G3_OUT.inc'
!
! WARNING This file is generated automatically by use_registry
! using the data base in the file named Registry.
! Do not edit.  Your changes to this file will be lost.
