...
'Error allocating TGLEND_TBL in urban_param_init')
            ...
            if(allocate_status /= 0) CALL wrf_error_fatal3("<stdin>",1798,&
...
'Error allocating PERFLO_TBL in urban_param_init')
            ...
            if(allocate_status /= 0) CALL wrf_error_fatal3("<stdin>",1860,&
'Error allocating HSESF_TBL in urban_param_init')
         ...
         if(allocate_status /= 0) CALL wrf_error_fatal3("<stdin>",1878,&
'Error allocating ROOF_WIDTH in urban_param_init')
         ...
         if(allocate_status /= 0) CALL wrf_error_fatal3("<stdin>",1884,&
