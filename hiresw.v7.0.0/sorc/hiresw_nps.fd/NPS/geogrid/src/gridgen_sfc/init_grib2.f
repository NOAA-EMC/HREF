...
! *** Section 3 ***
 ...
 if (trim(domain_type) == 'bgrid') then
   ...
   gfld%igdtmpl(3)=2**32-1    ! octs 17-20; scale value of radius of spherical earth, not used.
   gfld%igdtmpl(4)=255        ! oct 21; scale factor of major axis of elliptical earth, not used.
   gfld%igdtmpl(5)=2**32-1    ! octs 22-25; scaled value of major axis of elliptical earth, not used.
   gfld%igdtmpl(6)=255        ! oct 26; scale factor of minor axis of elliptical earth, not used.
   gfld%igdtmpl(7)=2**32-1    ! octs 27-30; scaled value of minor axis of elliptical earth, not used.
...
! note!! to use a parmeter number >= 192 you must set the local table to '1'
 ...
 gfld%ipdtmpl(15)=2**32-1   ! octs 31-34; scaled value of second fixed surface
