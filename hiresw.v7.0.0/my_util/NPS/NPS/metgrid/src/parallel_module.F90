...
!	call mprintf(.true.,ERROR,'my_minx is %i and my_maxx is %i.', i1=my_minx, i2=my_maxx)
!	call mprintf(.true.,ERROR,'my_miny is %i and my_maxy is %i.', i1=my_miny, i2=my_maxy)
