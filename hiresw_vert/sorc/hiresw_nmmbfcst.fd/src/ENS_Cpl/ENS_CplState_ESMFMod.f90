...
!--------------------------------------
 ...
 CALL GetF90ArrayFromState(impENS, 'pps', Cpl_Int_State%work1, 0, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get From impENS to the Cpl Internal State -- PS.")) THEN
 ...
 CALL DistributeForStep1_1(Cpl_Int_State%ps, Cpl_Int_State, rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Distribute for the Step1 Scheme -- PS.")) THEN
         rcfinal = ESMF_FAILURE
 ...
 CALL GetF90ArrayFromState(impENS, 'tt', Cpl_Int_State%work2, 0, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get From impENS to the Cpl Internal State -- T.")) THEN
         rcfinal = ESMF_FAILURE
 ...
 CALL DistributeForStep1(Cpl_Int_State%t, name, Cpl_Int_State, rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Distribute for the Step1 Scheme -- T.")) THEN
         rcfinal = ESMF_FAILURE
 ...
 CALL GetF90ArrayFromState(impENS, 'uu', Cpl_Int_State%work2, 0, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get From impENS to the Cpl Internal State -- U.")) THEN
         rcfinal = ESMF_FAILURE
 ...
 CALL DistributeForStep1(Cpl_Int_State%u, name, Cpl_Int_State, rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Distribute for the Step1 Scheme -- U.")) THEN
         rcfinal = ESMF_FAILURE
 ...
 CALL GetF90ArrayFromState(impENS, 'vv', Cpl_Int_State%work2, 0, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get From impENS to the Cpl Internal State -- V.")) THEN
         rcfinal = ESMF_FAILURE
 ...
 CALL DistributeForStep1(Cpl_Int_State%v, name, Cpl_Int_State, rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Distribute for the Step1 Scheme -- V.")) THEN
 ...
 CALL ESMF_StateGet(impENS, 'tracers', Bundle, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Retrieve Bundle from impENS in ENS Cpl.")) THEN
 ...
 DO j = 2, 5
     DO i = 1, Cpl_Int_State%ntrac
         ...
         IF(ESMF_LogMsgFoundError(rc1,     "Retrieve Field from Bundle in ENS Cpl.")) THEN
         ...
         IF(ESMF_LogMsgFoundError(rc1,     "Retrieve FArray from Field in ENS Cpl.")) THEN
         ...
         IF(ESMF_LogMsgFoundError(rc1,     "Distribute for the Step1 Scheme -- tracer.")) THEN
 ...
 CALL GetF90ArrayFromState(impENS, 'psm', Cpl_Int_State%work1, 0, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get From impENS to the Cpl Internal State -- PS(-DT).")) THEN
 ...
 CALL DistributeForStep1_1(Cpl_Int_State%psm, Cpl_Int_State, rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Distribute for the Step1 Scheme -- PS(-DT).")) THEN
 ...
 CALL GetF90ArrayFromState(impENS, 'tm', Cpl_Int_State%work2, 0, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get From impENS to the Cpl Internal State -- T(-DT).")) THEN
 ...
 CALL DistributeForStep1(Cpl_Int_State%tm, name, Cpl_Int_State, rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Distribute for the Step1 Scheme -- T(-DT).")) THEN
 ...
 CALL GetF90ArrayFromState(impENS, 'um', Cpl_Int_State%work2, 0, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get From impENS to the Cpl Internal State -- U(-DT).")) THEN
 ...
 CALL DistributeForStep1(Cpl_Int_State%um, name, Cpl_Int_State, rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Distribute for the Step1 Scheme -- U(-DT).")) THEN
 ...
 CALL GetF90ArrayFromState(impENS, 'vm', Cpl_Int_State%work2, 0, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get From impENS to the Cpl Internal State -- V(-DT).")) THEN
 ...
 CALL DistributeForStep1(Cpl_Int_State%vm, name, Cpl_Int_State, rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Distribute for the Step1 Scheme -- V(-DT).")) THEN
 ...
 CALL GetF90ArrayFromState(impENS, 'pps6', Cpl_Int_State%work1, 0, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get From impENS to the Cpl Internal State -- PS(-6H).")) THEN
 ...
 CALL DistributeForStep1_1(Cpl_Int_State%ps6, Cpl_Int_State, rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Distribute for the Step1 Scheme -- PS(-6H).")) THEN
 ...
 CALL GetF90ArrayFromState(impENS, 'tt6', Cpl_Int_State%work2, 0, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get From impENS to the Cpl Internal State -- T(-6H).")) THEN
 ...
 CALL DistributeForStep1(Cpl_Int_State%t6, name, Cpl_Int_State, rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Distribute for the Step1 Scheme -- T(-6H).")) THEN
 ...
 CALL GetF90ArrayFromState(impENS, 'uu6', Cpl_Int_State%work2, 0, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get From impENS to the Cpl Internal State -- U(-6H).")) THEN
 ...
 CALL DistributeForStep1(Cpl_Int_State%u6, name, Cpl_Int_State, rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Distribute for the Step1 Scheme -- U(-6H).")) THEN
 ...
 CALL GetF90ArrayFromState(impENS, 'vv6', Cpl_Int_State%work2, 0, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get From impENS to the Cpl Internal State -- V(-6H).")) THEN
 ...
 CALL DistributeForStep1(Cpl_Int_State%v6, name, Cpl_Int_State, rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Distribute for the Step1 Scheme -- V(-6H).")) THEN
 ...
 CALL GetF90ArrayFromState(impENS, 'psm6', Cpl_Int_State%work1, 0, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get From impENS to the Cpl Internal State -- PS(-6H-DT).")) THEN
 ...
 CALL DistributeForStep1_1(Cpl_Int_State%ps6m, Cpl_Int_State, rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Distribute for the Step1 Scheme -- PS(-6H-DT).")) THEN
 ...
 CALL GetF90ArrayFromState(impENS, 'tm6', Cpl_Int_State%work2, 0, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get From impENS to the Cpl Internal State -- T(-6H-DT).")) THEN
 ...
 CALL DistributeForStep1(Cpl_Int_State%t6m,  name, Cpl_Int_State, rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Distribute for the Step1 Scheme -- T(-6H-DT).")) THEN
 ...
 CALL GetF90ArrayFromState(impENS, 'um6', Cpl_Int_State%work2, 0, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get From impENS to the Cpl Internal State -- U(-6H-DT).")) THEN
 ...
 CALL DistributeForStep1(Cpl_Int_State%u6m, name, Cpl_Int_State, rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Distribute for the Step1 Scheme -- U(-6H-DT).")) THEN
 ...
 CALL GetF90ArrayFromState(impENS, 'vm6', Cpl_Int_State%work2, 0, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get From impENS to the Cpl Internal State -- V(-6H-DT).")) THEN
 ...
 CALL DistributeForStep1(Cpl_Int_State%v6m, name, Cpl_Int_State, rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Distribute for the Step1 Scheme -- V(-6H-DT).")) THEN
