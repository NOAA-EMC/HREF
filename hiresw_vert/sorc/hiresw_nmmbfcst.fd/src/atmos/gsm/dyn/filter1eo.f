...
!              dpme(indev,2,k) =         dpe (indev,2,k)
               dpme(indev,1,k) = filtb * dpme(indev,1,k)
     x                         + filta * dpe (indev,1,k)
               dpme(indev,2,k) = filtb * dpme(indev,2,k)
     x                         + filta * dpe (indev,2,k)
...
!              dpmo(indod,2,k) =         dpo (indod,2,k)
               dpmo(indod,1,k) = filtb * dpmo(indod,1,k)
     x                         + filta * dpo (indod,1,k)
               dpmo(indod,2,k) = filtb * dpmo(indod,2,k)
     x                         + filta * dpo (indod,2,k)
