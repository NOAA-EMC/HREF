...
!#######################################################################
      ...
      CALL ESMF_GridCompSetEntryPoint(GFS_GRID_COMP ,ESMF_SETINIT,GFS_INITIALIZE &
                                     ,ESMF_SINGLEPHASE                                     &
                                     ,RC)

      CALL ESMF_GridCompSetEntryPoint(GFS_GRID_COMP ,ESMF_SETRUN,GFS_RUN               &
                                     ,ESMF_SINGLEPHASE                                     &
                                     ,RC)
      CALL ESMF_GridCompSetEntryPoint(GFS_GRID_COMP ,ESMF_SETFINAL,GFS_FINALIZE     &
                                     ,ESMF_SINGLEPHASE                                     &
                                     ,RC)
