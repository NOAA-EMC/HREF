...
!
        CALL ESMF_StateAdd(            EXP_STATE                        &  !<-- The Domain export state
                          ,MOVE_BUNDLE_H                   &  !<-- Insert H-point MOVE_BUNDLE into the state
                          ,rc         =RC)
!
        CALL ESMF_StateAdd(            EXP_STATE                        &  !<-- The Domain export state
                          ,MOVE_BUNDLE_V                   &  !<-- Insert V-point MOVE_BUNDLE into the state
                          ,rc         =RC)
!
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
        CALL ERR_MSG(RC,MESSAGE_CHECK,RC_INIT)
