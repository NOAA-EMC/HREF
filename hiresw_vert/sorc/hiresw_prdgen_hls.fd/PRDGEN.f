...
C    
C    
      PARAMETER(IMAXIN=670,JJMAXIN=1170,JMAXIN=IMAXIN*JJMAXIN)
      PARAMETER(IMAXOT=400,JJMAXOT=400,JMAXOT=IMAXOT*JJMAXOT)
      PARAMETER(MAXTILE=36,MAXF=2000,MAXG=5,IBUFSIZE=1200000000)
