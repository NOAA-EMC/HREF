...
! --- temperature
          tnew(i,j) = tsfc
    if (i.eq.241.and. j.eq.87)print *,'**tnew(a)',validpt(i,j),tnew(i,j), &
     topo_ndfd(i,j),zs
...
!     being set to be much warmer than NAM 2m temp.
    ...
    if (i.eq.241.and. j.eq.87)print *,'**tnew(b)',validpt(i,j),tnew(i,j), &
     topo_ndfd(i,j),zs
...
! -----------------------------------------------------------------
 ...
 883      continue 
    if (i.eq.241.and. j.eq.87)print *,'z0-n >.05',validpt(i,j),tnew(i,j), &
...
! -----------------------------------------------------------------
 ...
 783 continue
    if (i.eq.241.and. j.eq.87)print *,'z0n<.05',validpt(i,j),tnew(i,j), &
