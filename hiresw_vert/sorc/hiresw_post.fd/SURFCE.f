...
!        ANEMOMETER LEVEL (10 M) U COMPONENT OF MAX WIND SPEED.

      IF (IGET(446).GT.0) THEN
         print *,' ***** outputting MAX10U'
         ID(1:25) = 0
         ID(02)=129
         ISVALUE = 10
         ID(10) = MOD(ISVALUE/256,256)
         ...
         ENDIF
            DO J=JSTA,JEND
            DO I=1,IM
             GRID1(I,J)=MAX10U(I,J)
            ENDDO
            ENDDO
         CALL GRIBIT(IGET(446),LVLS(1,IGET(446)),GRID1,IM,JM)
       ENDIF

!        ANEMOMETER LEVEL (10 M) V COMPONENT OF MAX WIND SPEED.

      IF (IGET(447).GT.0) THEN
         print *,' ***** outputting MAX10V'
         ID(1:25) = 0
         ID(02)=129
         ISVALUE = 10
         ID(10) = MOD(ISVALUE/256,256)
