       SUBROUTINE CALWXT(T,Q,RES,PD,HTM,LMH,PREC,PT,PDTOP
     +  ,SGML1,SGML2,SG1,SG2,IWX)
C 
C     FILE: CALWXT.f
...
C    PARAMETERS:
C      D608,ROG,H1,D00
       PARAMETER(D608=0.608,ROG=287.04/9.806,H1=1.0,D00=0.0)
C
C    INPUT:
C      T,Q,RES,PD,HTM,LMH,PREC,PT,AETA,ETA
      DIMENSION T(IM,jsta_2l:jend_2u,LM),Q(IM,jsta_2l:jend_2u,LM)
     &,         RES(IM,jsta_2l:jend_2u),PD(IM,jsta_2l:jend_2u)
     &,         HTM(IM,jsta_2l:jend_2u,LM)
      DIMENSION LMH(IM,JM),PREC(IM,JM),SG1(LP1),SG2(LP1)
     & ,SGML1(LM),SGML2(LM)
C    OUTPUT:
...
C
      ...
      QKL=AMAX1(H1M12,QKL)
      TKL=T(I,J,L)
      PKL=PDTOP*SGML1(L)+PDSL(I,J)*SGML2(L)+PT
C
...
C
        ...
        PINTK2=PDTOP*SG1(L)+PDSL(I,J)*SG2(L)+PT
