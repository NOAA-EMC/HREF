      SUBROUTINE CLMAX
     I (DSG1,DSG2,PDTOP,PDSL,HTM,Q2,ZINT,SM,HGT,LMH,IM,JM,LM,LP1
     O, EL0
     W, SQZ,SQ,RQ2L,RQ2H)
CFPP$ NOCONCUR R
C
...
C
                         D I M E N S I O N
     & DSG1(LM),DSG2(LM),PDSL(IM,JM),HTM(IM,jsta_2l:jend_2u,LM)
     &,Q2(IM,jsta_2l:jend_2u,LM)
     &,ZINT(IM,jsta_2l:jend_2u,LP1),SM(IM,JM),HGT(IM,jsta_2l:jend_2u)
     &,EL0(IM,JM),LMH(IM,JM)
...
C         -----------------------------------------------------------------
C
          DP=(DSG1(L)*PDTOP+DSG2(L)*PDSL(I,J))*HTM(I,J,L)
C***
