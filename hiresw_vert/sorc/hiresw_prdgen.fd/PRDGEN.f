...
C    
C    
      PARAMETER(IMAXIN=1700,JJMAXIN=1701,JMAXIN=IMAXIN*JJMAXIN)
!      PARAMETER(IMAXOT=550,JJMAXOT=550,JMAXOT=IMAXOT*JJMAXOT)
      PARAMETER(IMAXOT=2200,JJMAXOT=1400,JMAXOT=IMAXOT*JJMAXOT)
