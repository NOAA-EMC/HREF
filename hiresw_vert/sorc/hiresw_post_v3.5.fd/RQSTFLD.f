...
!!! why were these 49 and 50 (current) rather than 33 and 34 (wind)
      DATA IFILV(412),AVBL(412),IQ(412),IS(412)     &
     &                      /1,'U WIND AT 80M AGL   ',033,105/
      DATA IFILV(413),AVBL(413),IQ(413),IS(413)     &
     &                      /1,'V WIND AT 80M AGL   ',034,105/
      DATA IFILV(449),AVBL(449),IQ(449),IS(449)     &
     &                      /1,'TEMP AT 80M AGL     ',011,105/
      DATA IFILV(450),AVBL(450),IQ(450),IS(450)     &
     &                      /1,'PRES AT 80M AGL     ',001,105/
      DATA IFILV(451),AVBL(451),IQ(451),IS(451)     &
     &                      /1,'SPEC HUM AT 80M AGL ',051,105/
! CRA
...
! mp
     ...
     &                      /1,'U OF MAX 10M WIND   ',253,105/
      DATA IFILV(447),AVBL(447),IQ(447),IS(447) &
     &                      /1,'V OF MAX 10M WIND   ',254,105/
! mp
! SRD
! CRA
