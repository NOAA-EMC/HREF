...
c     DATA  GRD94 / 0, 255,203, 55,101,  16427, -162272, 136,   20250,
c    & -157350,    088,075,64, 0, 0, 0, 0, 0/
      DATA  GRD94 / 0, 255,203,340,563,  13246, -143473, 136,   50000,
     & -111000,    108,103,64, 0, 0, 0, 0, 0/ 
      DATA  GRD95 / 0, 255,203,303,429,  19943, -125093, 136,   40000,
     & -98000 ,    088,075,64, 0, 0, 0, 0, 0/
      DATA  GRD96 / 0, 255,203,606,1067, -3441, -148799, 136,   50000,
     & -111000,    088,075,64, 0, 0, 0, 0, 0/
cer   DATA  GRD96 / 0, 255,203,420,769,  13194, -143540, 136,   50000,
cer  & -111000,     88,75,64, 0, 0, 0, 0, 0/
c     DATA  GRD96 / 0, 255,203,419,768,  13194, -143540, 136,   50000,
c    & -111000,     88,75,64, 0, 0, 0, 0, 0/
      DATA  GRD97 / 0, 255,203, 55,101,  14435,  -71375, 136,   18250,
     &  -66500,    088,075,64, 0, 0, 0, 0, 0/
      DATA  GRD98 / 0, 255, 4, 192, 94,  88542,       0, 128,  -88542,
     &    -1875, 47,1875, 0, 0, 0, 0, 0, 0/
      DATA  GRD99 / 0, 255,203,233,331,  44197, -185241, 136,   61000,
     & -157000,    088,075,64, 0, 0, 0, 0, 0/
...
c4km
     ...
     &   4000,  4000, 0, 64, 0, 38500, 38500, 0, 0/
...
C
c8day
      DATA  GRD180/ 0, 255, 3, 148,179,  30000,  -86000,   8,  -77000,
     &  12000, 12000, 0, 64, 0, 38000, 38000, 0, 0/
      DATA  GRD181/ 0, 255, 3, 269,183,  30000, -113000,   8,  -94000,
     &  12000, 12000, 0, 64, 0, 40000, 40000, 0, 0/
      DATA  GRD182/ 0, 255, 3, 275,147,  23000, -110000,   8,  -96000,
     &  12000, 12000, 0, 64, 0, 31000, 31000, 0, 0/
      DATA  GRD183/ 0, 255, 3, 186,195,  29000, -126000,   8, -113000,
     &  12000, 12000, 0, 64, 0, 40000, 40000, 0, 0/
...
C
C Temp grid #'s for WRF-EM Hawaii and Puerto Rico mercator grids
c     DATA  GRD252/ 0, 255, 1, 134,100, 16522,  -162279, 128,   23891,
c    & -151721,   8000,   8000, 25000, 64, 0, 0, 0, 0/
      DATA  GRD253/ 0, 255, 1, 134,100, 14481,   -71779, 128,   21939,
     &  -61221,   8000,   8000, 25000, 64, 0, 0, 0, 0/
      DATA  GRD252/ 0, 255, 3, 301,225,  16281, -126138,  8,   -95000,
     &   20317,  20317, 0, 64, 0, 25000, 25000, 0, 0/
      DATA  GRD254/ 0, 255, 5, 361,270,  -5396, -147050,   8, -110000,
     &   45633,  45633, 0, 64, 0, 0, 0, 0, 0/
C
      IERR = 0
C
        DO 1 I = 1,18
