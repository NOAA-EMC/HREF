                 ...
                 DO ni = nits, nite
                    IF ( nfld(ni,nk,nj) .LT. -1.e19 ) THEN
                       ...
                       IF ( icount .GT. 0 ) THEN
                          nfld(ni,nk,nj) = sum / REAL ( icount ) 
                       ELSE
!                         CALL wrf_error_fatal3 ( "interp_fcn.b" , 4665 ,  "horizontal interp error - island" )
         ...
         ENDIF
      ELSE
         CALL wrf_error_fatal3 ( "interp_fcn.b" , 4676 ,  "only unstaggered fields right now" )
      END IF
               ...
               DO ni = nits, nite
                  IF ( nfld(ni,nk,nj) .LT. -1.e19 ) THEN
                     ...
                     IF ( icount .GT. 0 ) THEN
                        nfld(ni,nk,nj) = sum / REAL ( icount ) 
                     ELSE
!                       CALL wrf_error_fatal3 ( "interp_fcn.b" , 4892 ,  "horizontal interp error - lake" )
         ...
         END DO
      ELSE
         CALL wrf_error_fatal3 ( "interp_fcn.b" , 4901 ,  "only unstaggered fields right now" )
      END IF
