...
CALL wrf_ext_read_field (  &
                       ...
                       'XZY'               , &  ! MemoryOrder
                       'XZ'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field UU memorder XZY' , & ! Debug message
...
CALL wrf_ext_read_field (  &
                       ...
                       'XZY'               , &  ! MemoryOrder
                       'YZ'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field VV memorder XZY' , & ! Debug message
...
CALL wrf_ext_read_field (  &
                       ...
                       'XZY'               , &  ! MemoryOrder
                       'Z'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field TT memorder XZY' , & ! Debug message
...
CALL wrf_ext_read_field (  &
                       ...
                       'XZY'               , &  ! MemoryOrder
                       'Z'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field RH memorder XZY' , & ! Debug message
ids , (ide-1) , 1 , config_flags%num_metgrid_levels , jds , (jde-1) ,  & 
ims , ime , 1 , config_flags%num_metgrid_levels , jms , jme ,  & 
ips , MIN( (ide-1), ipe ) , 1 , config_flags%num_metgrid_levels , jps , MIN( (jde-1), jpe ) ,  & 
                       ierr )
...
CALL wrf_ext_read_field (  &
                       ...
                       'XZY'               , &  ! MemoryOrder
                       'Z'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field GHT memorder XZY' , & ! Debug message
ids , (ide-1) , 1 , config_flags%num_metgrid_levels , jds , (jde-1) ,  & 
ims , ime , 1 , config_flags%num_metgrid_levels , jms , jme ,  & 
ips , MIN( (ide-1), ipe ) , 1 , config_flags%num_metgrid_levels , jps , MIN( (jde-1), jpe ) ,  & 
                       ierr )
...
CALL wrf_ext_read_field (  &
                       ...
                       'XZY'               , &  ! MemoryOrder
                       'Z'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field PRES memorder XZY' , & ! Debug message
ids , (ide-1) , 1 , config_flags%num_metgrid_levels , jds , (jde-1) ,  & 
ims , ime , 1 , config_flags%num_metgrid_levels , jms , jme ,  & 
ips , MIN( (ide-1), ipe ) , 1 , config_flags%num_metgrid_levels , jps , MIN( (jde-1), jpe ) ,  & 
                       ierr )
...
CALL wrf_ext_read_field (  &
                       ...
                       'XY'               , &  ! MemoryOrder
                       ''               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field TAVGSFC memorder XY' , & ! Debug message
ids , (ide-1) , jds , (jde-1) , 1 , 1 ,  & 
ims , ime , jms , jme , 1 , 1 ,  & 
ips , MIN( (ide-1), ipe ) , jps , MIN( (jde-1), jpe ) , 1 , 1 ,  & 
                       ierr )
...
CALL wrf_ext_read_field (  &
                       ...
                       'XY'               , &  ! MemoryOrder
                       ''               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field PMSL memorder XY' , & ! Debug message
ids , (ide-1) , jds , (jde-1) , 1 , 1 ,  & 
ims , ime , jms , jme , 1 , 1 ,  & 
ips , MIN( (ide-1), ipe ) , jps , MIN( (jde-1), jpe ) , 1 , 1 ,  & 
                       ierr )
...
CALL wrf_ext_read_field (  &
                       ...
                       'XZY'               , &  ! MemoryOrder
                       'Z'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field GREENFRAC memorder XZY' , & ! Debug message
...
CALL wrf_ext_read_field (  &
                       ...
                       'XZY'               , &  ! MemoryOrder
                       'Z'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field ALBEDO12M memorder XZY' , & ! Debug message
ids , (ide-1) , 1 , 12 , jds , (jde-1) ,  & 
ims , ime , 1 , 12 , jms , jme ,  & 
ips , MIN( (ide-1), ipe ) , 1 , 12 , jps , MIN( (jde-1), jpe ) ,  & 
                       ierr )
...
CALL wrf_ext_read_field (  &
                       ...
                       'XZY'               , &  ! MemoryOrder
                       'Z'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field QV memorder XZY' , & ! Debug message
ids , (ide-1) , 1 , config_flags%num_metgrid_levels , jds , (jde-1) ,  & 
ims , ime , 1 , config_flags%num_metgrid_levels , jms , jme ,  & 
ips , MIN( (ide-1), ipe ) , 1 , config_flags%num_metgrid_levels , jps , MIN( (jde-1), jpe ) ,  & 
                       ierr )
...
CALL wrf_ext_read_field (  &
                       ...
                       'XZY'               , &  ! MemoryOrder
                       'X'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field U memorder XZY' , & ! Debug message
...
CALL wrf_ext_read_field (  &
                       ...
                       'XZY'               , &  ! MemoryOrder
                       'Y'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field V memorder XZY' , & ! Debug message
...
CALL wrf_ext_read_field (  &
                       ...
                       'XZY'               , &  ! MemoryOrder
                       ''               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field T memorder XZY' , & ! Debug message
...
CALL wrf_ext_read_field (  &
                       ...
                       'XY'               , &  ! MemoryOrder
                       ''               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field MU0 memorder XY' , & ! Debug message
ids , (ide-1) , jds , (jde-1) , 1 , 1 ,  & 
ims , ime , jms , jme , 1 , 1 ,  & 
ips , MIN( (ide-1), ipe ) , jps , MIN( (jde-1), jpe ) , 1 , 1 ,  & 
                       ierr )
...
CALL wrf_ext_read_field (  &
                       ...
                       'Z'               , &  ! MemoryOrder
                       'Z'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field ZNW memorder Z' , & ! Debug message
kds , kde , 1 , 1 , 1 , 1 ,  & 
kms , kme , 1 , 1 , 1 , 1 ,  & 
...
CALL wrf_ext_read_field (  &
                       ...
                       'XY'               , &  ! MemoryOrder
                       ''               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field SHDMAX memorder XY' , & ! Debug message
ids , (ide-1) , jds , (jde-1) , 1 , 1 ,  & 
ims , ime , jms , jme , 1 , 1 ,  & 
ips , MIN( (ide-1), ipe ) , jps , MIN( (jde-1), jpe ) , 1 , 1 ,  & 
                       ierr )
CALL wrf_ext_read_field (  &
                       ...
                       'XY'               , &  ! MemoryOrder
                       ''               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field SHDMIN memorder XY' , & ! Debug message
ids , (ide-1) , jds , (jde-1) , 1 , 1 ,  & 
ims , ime , jms , jme , 1 , 1 ,  & 
ips , MIN( (ide-1), ipe ) , jps , MIN( (jde-1), jpe ) , 1 , 1 ,  & 
                       ierr )
...
CALL wrf_ext_read_field (  &
                       ...
                       'XZY'               , &  ! MemoryOrder
                       'Z'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field LANDUSEF memorder XZY' , & ! Debug message
...
CALL wrf_ext_read_field (  &
                       ...
                       'XZY'               , &  ! MemoryOrder
                       'Z'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field SOILCTOP memorder XZY' , & ! Debug message
...
CALL wrf_ext_read_field (  &
                       ...
                       'XZY'               , &  ! MemoryOrder
                       'Z'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field SOILCBOT memorder XZY' , & ! Debug message
ids , (ide-1) , 1 , config_flags%num_soil_cat , jds , (jde-1) ,  & 
ims , ime , 1 , config_flags%num_soil_cat , jms , jme ,  & 
ips , MIN( (ide-1), ipe ) , 1 , config_flags%num_soil_cat , jps , MIN( (jde-1), jpe ) ,  & 
                       ierr )
...
DO itrace = PARAM_FIRST_SCALAR , num_ozmixm
  IF (BTEST(ozmixm_stream_table(grid%id, itrace ) , switch )) THEN
    CALL wrf_ext_read_field (  &
          ...
          'XZY'               , &  ! MemoryOrder
          ''                , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_write_field '//TRIM(ozmixm_dname_table( grid%id, itrace ))//' memorder XZY' , & ! Debug message
...
DO itrace = PARAM_FIRST_SCALAR , num_aerosolc
  IF (BTEST(aerosolc_stream_table(grid%id, itrace ) , switch )) THEN
    CALL wrf_ext_read_field (  &
          ...
          'XZY'               , &  ! MemoryOrder
          ''                , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_write_field '//TRIM(aerosolc_dname_table( grid%id, itrace ))//' memorder XZY' , & ! Debug message
...
CALL wrf_ext_read_field (  &
                       ...
                       'XY'               , &  ! MemoryOrder
                       ''               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field MAPFAC_M memorder XY' , & ! Debug message
ids , (ide-1) , jds , (jde-1) , 1 , 1 ,  & 
ims , ime , jms , jme , 1 , 1 ,  & 
ips , MIN( (ide-1), ipe ) , jps , MIN( (jde-1), jpe ) , 1 , 1 ,  & 
                       ierr )
CALL wrf_ext_read_field (  &
                       ...
                       'XY'               , &  ! MemoryOrder
                       'X'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field MAPFAC_U memorder XY' , & ! Debug message
...
CALL wrf_ext_read_field (  &
                       ...
                       'XY'               , &  ! MemoryOrder
                       'Y'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field MAPFAC_V memorder XY' , & ! Debug message
...
CALL wrf_ext_read_field (  &
                       ...
                       'XY'               , &  ! MemoryOrder
                       ''               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field F memorder XY' , & ! Debug message
ids , (ide-1) , jds , (jde-1) , 1 , 1 ,  & 
ims , ime , jms , jme , 1 , 1 ,  & 
ips , MIN( (ide-1), ipe ) , jps , MIN( (jde-1), jpe ) , 1 , 1 ,  & 
                       ierr )
CALL wrf_ext_read_field (  &
                       ...
                       'XY'               , &  ! MemoryOrder
                       ''               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field E memorder XY' , & ! Debug message
ids , (ide-1) , jds , (jde-1) , 1 , 1 ,  & 
ims , ime , jms , jme , 1 , 1 ,  & 
ips , MIN( (ide-1), ipe ) , jps , MIN( (jde-1), jpe ) , 1 , 1 ,  & 
                       ierr )
CALL wrf_ext_read_field (  &
                       ...
                       'XY'               , &  ! MemoryOrder
                       ''               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field SINALPHA memorder XY' , & ! Debug message
ids , (ide-1) , jds , (jde-1) , 1 , 1 ,  & 
ims , ime , jms , jme , 1 , 1 ,  & 
ips , MIN( (ide-1), ipe ) , jps , MIN( (jde-1), jpe ) , 1 , 1 ,  & 
                       ierr )
CALL wrf_ext_read_field (  &
                       ...
                       'XY'               , &  ! MemoryOrder
                       ''               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field COSALPHA memorder XY' , & ! Debug message
ids , (ide-1) , jds , (jde-1) , 1 , 1 ,  & 
ims , ime , jms , jme , 1 , 1 ,  & 
ips , MIN( (ide-1), ipe ) , jps , MIN( (jde-1), jpe ) , 1 , 1 ,  & 
                       ierr )
CALL wrf_ext_read_field (  &
                       ...
                       'XY'               , &  ! MemoryOrder
                       ''               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field HGT memorder XY' , & ! Debug message
ids , (ide-1) , jds , (jde-1) , 1 , 1 ,  & 
ims , ime , jms , jme , 1 , 1 ,  & 
ips , MIN( (ide-1), ipe ) , jps , MIN( (jde-1), jpe ) , 1 , 1 ,  & 
                       ierr )
...
CALL wrf_ext_read_field (  &
                       ...
                       'XY'               , &  ! MemoryOrder
                       ''               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field XLAT memorder XY' , & ! Debug message
ids , (ide-1) , jds , (jde-1) , 1 , 1 ,  & 
ims , ime , jms , jme , 1 , 1 ,  & 
ips , MIN( (ide-1), ipe ) , jps , MIN( (jde-1), jpe ) , 1 , 1 ,  & 
                       ierr )
CALL wrf_ext_read_field (  &
                       ...
                       'XY'               , &  ! MemoryOrder
                       ''               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field XLONG memorder XY' , & ! Debug message
ids , (ide-1) , jds , (jde-1) , 1 , 1 ,  & 
ims , ime , jms , jme , 1 , 1 ,  & 
ips , MIN( (ide-1), ipe ) , jps , MIN( (jde-1), jpe ) , 1 , 1 ,  & 
                       ierr )
...
CALL wrf_ext_read_field (  &
                       ...
                       'XY'               , &  ! MemoryOrder
                       'X'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field XLAT_U memorder XY' , & ! Debug message
ids , ide , jds , (jde-1) , 1 , 1 ,  & 
ims , ime , jms , jme , 1 , 1 ,  & 
ips , MIN( ide, ipe ) , jps , MIN( (jde-1), jpe ) , 1 , 1 ,  & 
                       ierr )
...
CALL wrf_ext_read_field (  &
                       ...
                       'XY'               , &  ! MemoryOrder
                       'X'               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field XLONG_U memorder XY' , & ! Debug message
ids , ide , jds , (jde-1) , 1 , 1 ,  & 
ims , ime , jms , jme , 1 , 1 ,  & 
ips , MIN( ide, ipe ) , jps , MIN( (jde-1), jpe ) , 1 , 1 ,  & 
                       ierr )
...
CALL wrf_ext_read_field (  &
                       ...
                       'XY'               , &  ! MemoryOrder
                       ''               , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_read_field TMN memorder XY' , & ! Debug message
ids , (ide-1) , jds , (jde-1) , 1 , 1 ,  & 
ims , ime , jms , jme , 1 , 1 ,  & 
ips , MIN( (ide-1), ipe ) , jps , MIN( (jde-1), jpe ) , 1 , 1 ,  & 
                       ierr )
DO itrace = PARAM_FIRST_SCALAR , num_fdda3d
  IF (BTEST(fdda3d_stream_table(grid%id, itrace ) , switch )) THEN
    CALL wrf_ext_read_field (  &
          ...
          'XZY'               , &  ! MemoryOrder
          ''                , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_write_field '//TRIM(fdda3d_dname_table( grid%id, itrace ))//' memorder XZY' , & ! Debug message
ids , (ide-1) , kds , (kde-1) , jds , (jde-1) ,  & 
ims , ime , kms , kme , jms , jme ,  & 
ips , MIN( (ide-1), ipe ) , kps , MIN( (kde-1), kpe ) , jps , MIN( (jde-1), jpe ) ,  & 
                         ierr )
...
DO itrace = PARAM_FIRST_SCALAR , num_fdda2d
  IF (BTEST(fdda2d_stream_table(grid%id, itrace ) , switch )) THEN
    CALL wrf_ext_read_field (  &
          ...
          'XZY'               , &  ! MemoryOrder
          'Z'                , &  ! Stagger
'inc/wrf_auxinput1in.inc ext_write_field '//TRIM(fdda2d_dname_table( grid%id, itrace ))//' memorder XZY' , & ! Debug message
