...
!EOP
      ...
      ALLOCATE(clockint%AlarmList(28))
...
! !ARGUMENTS:
      type(ESMF_Clock), intent(inout) :: clock
      type(ESMF_Alarm), dimension(28), intent(out), optional :: &
                                        RingingAlarmList
...
! !ARGUMENTS:
      ...
      type(ESMF_Alarm), dimension(28), intent(in) :: AlarmList
      integer, intent(out), optional :: rc
...
! !ARGUMENTS:
      ...
      type(ESMF_Time), intent(out) :: PrevTime
      integer(ESMF_KIND_I8), intent(out) :: AdvanceCount
      type(ESMF_Alarm), dimension(28), intent(out) :: AlarmList
      integer, intent(out), optional :: rc
