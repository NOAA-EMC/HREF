...
! scalar.  NEEDS FURTHER ATTENTION. JM 20050215
       ...
       ELSE
         CALL wrf_error_fatal3 ( "module_surface_driver.b" , 569 , 'Lacking arguments for SFCLAY in surface driver')
       ENDIF
...
!           PRESENT(emiss)      .AND.  PRESENT(t2)      .AND.    &
       ...
       ELSE
         CALL wrf_error_fatal3 ( "module_surface_driver.b" , 845 , 'Lacking arguments for RUCLSM in surface driver')
       ENDIF
     ...
     CASE DEFAULT
       ...
       CALL wrf_error_fatal3 ( "module_surface_driver.b" , 852 ,  message )
