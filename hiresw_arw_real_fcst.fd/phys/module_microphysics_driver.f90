...
!-----------
     ...
     micro_select: SELECT CASE(mp_physics)
        ...
        CASE (KESSLERSCHEME)
             ...
             ELSE 
                CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 298 ,  'arguments not present for calling kessler' )
             ENDIF
...
!
        CASE (THOMPSON)
             ...
             CALL mp_gt_driver(                          &
                 ...
                 ,ITS=its,ITE=ite, JTS=jts,JTE=jte, KTS=kts,KTE=kte)
             ELSE
                CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 330 ,  'arguments not present for calling thompson_et_al' )
             ENDIF
!
        CASE (LINSCHEME)
             ...
             ELSE 
                CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 362 ,  'arguments not present for calling lin_et_al' )
             ENDIF
        ...
        CASE (WSM3SCHEME)
             ...
             ELSE 
                CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 391 ,  'arguments not present for calling wsm3' )
             ENDIF
        ...
        CASE (WSM5SCHEME)
             ...
             ELSE
                CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 422 ,  'arguments not present for calling wsm5' )
             ENDIF
        ...
        CASE (WSM6SCHEME)
             ...
             ELSE
                CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 455 ,  'arguments not present for calling wsm6' )
             ENDIF
        ...
        CASE (ETAMPNEW)
             ...
             ELSE
                CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 485 ,  'arguments not present for calling etampnew' )
             ENDIF
        ...
        CASE (NCEPCLOUD3)
             ...
             ELSE
                CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 513 ,  'arguments not present for calling ncepcloud3' )
             ENDIF
        ...
        CASE (NCEPCLOUD5)
             ...
             ELSE
                CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 543 ,  'arguments not present for calling ncepcloud5' )
             ENDIF
      ...
      CASE DEFAULT 
         ...
         CALL wrf_error_fatal3 ( "module_microphysics_driver.b" , 550 ,  wrf_err_message )
