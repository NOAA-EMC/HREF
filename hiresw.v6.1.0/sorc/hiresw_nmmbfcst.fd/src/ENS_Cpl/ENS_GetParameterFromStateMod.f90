...
!----------------------------------------------------------------
 CALL ESMF_AttributeGet(State, 'NTRAC', Int_State%ntrac, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get ntrac from the ENS Cpl import state.")) THEN
 ...
 CALL ESMF_AttributeGet(State, 'MPI_R_MPI_R', Int_State%MPI_R_MPI_R, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get MPI_R_MPI_R from the ENS Cpl import state.")) THEN
         rcfinal = ESMF_FAILURE
 ...
 CALL ESMF_AttributeGet(State, 'JCAP', Int_State%jcap, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get JCAP from the ENS Cpl import state.")) THEN
         rcfinal = ESMF_FAILURE
 ...
 CALL ESMF_AttributeGet(State, 'NODES_COMP', Int_State%nodes_comp, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get NODES_COMP from the ENS Cpl import state.")) THEN
         rcfinal = ESMF_FAILURE
 ...
 CALL ESMF_AttributeGet(State, 'ME_COMP', Int_State%me_comp, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get ME_COMP from the ENS Cpl import state.")) THEN
         rcfinal = ESMF_FAILURE
 ...
 CALL ESMF_AttributeGet(State, 'MC_COMP', Int_State%MC_COMP, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get MC_COMP from the ENS Cpl import state.")) THEN
         rcfinal = ESMF_FAILURE
 ...
 CALL ESMF_AttributeGet(State, 'LATS_NODE_A', Int_State%lats_node_a, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get LATS_NODE_A from the ENS Cpl import state.")) THEN
         rcfinal = ESMF_FAILURE
 ...
 CALL ESMF_AttributeGet(State, 'IPT_LATS_NODE_A', Int_State%ipt_lats_node_a, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get IPT_LATS_NODE_A from the ENS Cpl import state.")) THEN
         rcfinal = ESMF_FAILURE
 ...
 CALL ESMF_AttributeGet(State, 'LONF', Int_State%lonf, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get LONF from the ENS Cpl import state.")) THEN
 ...
 CALL ESMF_AttributeGet(State, 'LATG', Int_State%latg, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get LATG from the ENS Cpl import state.")) THEN
 ...
 CALL ESMF_AttributeGet(State, 'GLOBAL_LATS_A', Int_State%latg, Int_State%global_lats_a, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get GLOBAL_LATS_A from the ENS Cpl import state.")) THEN
 ...
 CALL ESMF_AttributeGet(State, 'LONSPERLAT', Int_State%latg, Int_State%lonsperlat, rc = rc1)
     ...
     IF(ESMF_LogMsgFoundError(rc1,     "Get LONSPERLAT from the ENS Cpl import state.")) THEN
