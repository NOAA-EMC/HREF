...
!
      ...
      use namelist_dynamics_def, only : fhrot,fhini,nemsio_in
...
!     call tracer_config_init( gis_dyn%gfs_dyn_tracer, gis_dyn%ntrac,   &
      ...
      call tracer_config_init( gis_dyn%ntrac, gis_dyn%ntoz,             &
                               gis_dyn%ntcw,  gis_dyn%ncld,  me )
