...
c                 J     = 36062
                  J     = 58081    ! 3 km Puerto Rico nest 241*241 
                  GO TO 800
              ELSE IF (KPDS(3).EQ.96) THEN
C                       ----- U.S GRID 96     - MAP SIZE 646602
c                 J     = 646602
                  J     = 209253   ! 3 km Hawaii nest 373*561
                  GO TO 800
              ELSE IF (KPDS(3).EQ.97) THEN
C                       ----- U.S GRID 97     - MAP SIZE 12727
c                 J     = 12727
                  J     = 1508100   ! 4 km CONUS NEST 1371*1100
                  GO TO 800
              ELSE IF (KPDS(3).EQ.98) THEN
C                       ----- U.S GRID 98     - MAP SIZE 18048
c                 J     = 18048
                  J     = 371875    ! 6 km Alaska nest 595*625
                  GO TO 800
              ELSE IF (KPDS(3).EQ.99) THEN
C                       ----- U.S GRID 99     - MAP SIZE 779385
c                 J     = 779385
c                 J     = 32430
C                 J     = 398184    !-- IM*JM=706*564 grid points
c                 J     = 865861    !-- IM*JM=961*901 grid points
                  J     = 796590    !-- IM*JM=954*835 grid points
                  GO TO 800
              END IF
...
C                 ----- U.S. GRID 151 - MAP SIZE 244305
                  J = 244305
                  GO TO 800
              ELSE IF (KPDS(3).EQ.179) THEN
C                 ----- U.S. GRID 180 - MAP SIZE 26492
                  J     = 977132
                  GO TO 800
...
C                 ----- U.S. GRID 181 - MAP SIZE 49227
                  J     = 102860
                  GO TO 800
              ELSE IF (KPDS(3).EQ.182) THEN
C                 ----- U.S. GRID 182 - MAP SIZE 40425
                  J     = 64218
                  GO TO 800
              ELSE IF (KPDS(3).EQ.183) THEN
C                 ----- U.S. GRID 183 - MAP SIZE 36270
                  J     = 180144
                  GO TO 800
      ...
      ELSE IF (KPDS(1).EQ.7) THEN
          ...
          ELSE IF (KPDS(3).EQ.179) THEN
              IF (I.NE.J) THEN
                  RETURN
              END IF
          ELSE IF (KPDS(3).GE.180.OR.KPDS(3).LE.189) THEN
              IF (I.NE.J) THEN
                  RETURN 1
              END IF
          ...
          ELSE IF (KPDS(3).EQ.195) THEN
              IF (I.NE.J) THEN
                  RETURN
              END IF
          ELSE IF (KPDS(3).EQ.197.OR.KPDS(3).EQ.198) THEN
              IF (I.NE.J) THEN
                  RETURN
              END IF
