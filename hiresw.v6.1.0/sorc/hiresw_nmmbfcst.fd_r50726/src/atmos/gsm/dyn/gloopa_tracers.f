...
!
      ...
      real(kind=kind_evod) :: tref, tzero,rcs2_loc,psref
...
!
      ...
      logical go_forward,lprnt,end_step
      logical, save :: first
      data first/.true./
...
!         global_times_a(lat,me+1)=timer2-timer1
      ...
      IF (lsout.and.kdt /= 0) THEN
        CALL wrtout_dynamics_slg_nemsio(fhour,
...
!     write(0,*)' in gloopa rgt_hq=',rgt_h(xhalo+1,:,yhalo+10,1),
!    &' kdt=',kdt
!     write(0,*)' in gloopa rgt_ho3=',rgt_h(xhalo+1,:,yhalo+10,2),
!    &' kdt=',kdt
!     write(0,*)' in gloopa rgt_h=clw',rgt_h(xhalo+1,:,yhalo+10,3),
!    &' kdt=',kdt
