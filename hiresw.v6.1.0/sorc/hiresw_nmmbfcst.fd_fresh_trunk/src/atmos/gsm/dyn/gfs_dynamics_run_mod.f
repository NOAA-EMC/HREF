...
!                                  gis_dyn%grid_gr_dfi,   gis_dyn%GRID_GR6,         &
        ...
        gis_dyn%phour = fhour
!       write(0,*)' returned from do_dynamics_slg_loop'
...
!     write(0,*)' before model_to_common_vars fhour=',fhour,gis_dyn%ENS    &
!    &, gis_dyn%end_step
! ---------------------------------------------------------------------
...
!
     ...
     ELSE
!     write(0,*)' calling model_to_common_vars',                             &
!    'g_zqp=',gis_dyn%g_zqp,' g_ttp=',gis_dyn%g_ttp,' g_rqp=',gis_dyn%g_rqp, &
!    ' g_uup=',gis_dyn%g_uup,' g_vvp=',gis_dyn%g_vvp,' g_dpp=',gis_dyn%g_dpp,&
!    ' g_p=',gis_dyn%g_p,' g_dpdt=',gis_dyn%g_dpdt
!       if (semilag) then
...
!                                     gis_dyn% grid_gr(1,1,gis_dyn%g_dpn),   &
!                                     gis_dyn% grid_gr(1,1,gis_dyn%g_p  ),   &
!                                     gis_dyn% grid_gr(1,1,gis_dyn%g_dpdt ), &
!                                     gis_dyn%global_lats_a,                 &
!                                     gis_dyn%lonsperlat,1)
...
!     write(150+me,*)' rqp=',gis_dyn% grid_gr(1,1,gis_dyn%g_rqp+3*gis_dyn%levs-3:  &
!                                            gis_dyn%g_rqp+3*gis_dyn%levs-1)  &
!    &,' me=',me,'gis_dyn%g_rqp=',gis_dyn%g_rqp,3*gis_dyn%levs
...
!       endif
!      if(gis_dyn % kdt<=1) then
!        write(0,*)'in gfs dyn run,af mdl2com kdt=',gis_dyn%kdt,'ps=',                 &
!        maxval(gis_dyn%grid_gr(:,:,g_q)),                                             &
!        minval(gis_dyn%grid_gr(:,:,g_q)),'u=',maxval(gis_dyn%grid_gr(:,:,g_u)),       &
!        write(0,*)'in gfs dyn run,af mdl2com kdt=',gis_dyn%kdt,                       &
!        'u=',maxval(gis_dyn%grid_gr(:,:,g_u)),                                        &
...
!     write(0,*)' checking for return code after calling model_to_common_vars'
      if(present(rc)) then
          rc = rc1
      end if
