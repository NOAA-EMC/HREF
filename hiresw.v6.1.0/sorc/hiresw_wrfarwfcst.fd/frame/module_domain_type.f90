...
integer :: nodyn_dummy
character*256 :: windturbines_spec
integer :: td_turbgridid
real :: td_hubheight
real :: td_diameter
real :: td_stdthrcoef
real :: td_cutinspeed
...
real ,DIMENSION(:,:) ,POINTER :: soilm001
real ,DIMENSION(:,:) ,POINTER :: soilm004
real ,DIMENSION(:,:) ,POINTER :: soilm005
real ,DIMENSION(:,:) ,POINTER :: soilm010
real ,DIMENSION(:,:) ,POINTER :: soilm020
real ,DIMENSION(:,:) ,POINTER :: soilm030
real ,DIMENSION(:,:) ,POINTER :: soilm040
real ,DIMENSION(:,:) ,POINTER :: soilm060
real ,DIMENSION(:,:) ,POINTER :: soilm100
...
real ,DIMENSION(:,:) ,POINTER :: soilt001
real ,DIMENSION(:,:) ,POINTER :: soilt004
real ,DIMENSION(:,:) ,POINTER :: soilt005
real ,DIMENSION(:,:) ,POINTER :: soilt010
real ,DIMENSION(:,:) ,POINTER :: soilt020
real ,DIMENSION(:,:) ,POINTER :: soilt030
real ,DIMENSION(:,:) ,POINTER :: soilt040
real ,DIMENSION(:,:) ,POINTER :: soilt060
real ,DIMENSION(:,:) ,POINTER :: soilt100
...
real ,DIMENSION(:,:,:) ,POINTER :: el_mynn
...
real ,DIMENSION(:,:,:) ,POINTER :: gd_cloud_b
real ,DIMENSION(:,:,:) ,POINTER :: gd_cloud2_b
