...
ENDIF
IF ( ASSOCIATED( grid%soilm001 ) ) THEN
  DEALLOCATE(grid%soilm001,STAT=ierr)
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",3743,&
'frame/module_domain.f: Failed to deallocate grid%soilm001. ')
 endif
ENDIF
IF ( ASSOCIATED( grid%soilm004 ) ) THEN
  DEALLOCATE(grid%soilm004,STAT=ierr)
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",3750,&
'frame/module_domain.f: Failed to deallocate grid%soilm004. ')
 endif
ENDIF
...
ENDIF
IF ( ASSOCIATED( grid%soilm010 ) ) THEN
  DEALLOCATE(grid%soilm010,STAT=ierr)
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",3764,&
'frame/module_domain.f: Failed to deallocate grid%soilm010. ')
 endif
ENDIF
...
ENDIF
IF ( ASSOCIATED( grid%soilm030 ) ) THEN
  DEALLOCATE(grid%soilm030,STAT=ierr)
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",3778,&
'frame/module_domain.f: Failed to deallocate grid%soilm030. ')
 endif
ENDIF
...
ENDIF
IF ( ASSOCIATED( grid%soilm060 ) ) THEN
  DEALLOCATE(grid%soilm060,STAT=ierr)
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",3792,&
'frame/module_domain.f: Failed to deallocate grid%soilm060. ')
 endif
ENDIF
IF ( ASSOCIATED( grid%soilm100 ) ) THEN
  DEALLOCATE(grid%soilm100,STAT=ierr)
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",3799,&
'frame/module_domain.f: Failed to deallocate grid%soilm100. ')
 endif
ENDIF
...
ENDIF
IF ( ASSOCIATED( grid%soilt001 ) ) THEN
  DEALLOCATE(grid%soilt001,STAT=ierr)
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",3939,&
'frame/module_domain.f: Failed to deallocate grid%soilt001. ')
 endif
ENDIF
IF ( ASSOCIATED( grid%soilt004 ) ) THEN
  DEALLOCATE(grid%soilt004,STAT=ierr)
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",3946,&
'frame/module_domain.f: Failed to deallocate grid%soilt004. ')
 endif
ENDIF
...
ENDIF
IF ( ASSOCIATED( grid%soilt010 ) ) THEN
  DEALLOCATE(grid%soilt010,STAT=ierr)
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",3960,&
'frame/module_domain.f: Failed to deallocate grid%soilt010. ')
 endif
ENDIF
...
ENDIF
IF ( ASSOCIATED( grid%soilt030 ) ) THEN
  DEALLOCATE(grid%soilt030,STAT=ierr)
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",3974,&
'frame/module_domain.f: Failed to deallocate grid%soilt030. ')
 endif
ENDIF
...
ENDIF
IF ( ASSOCIATED( grid%soilt060 ) ) THEN
  DEALLOCATE(grid%soilt060,STAT=ierr)
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",3988,&
'frame/module_domain.f: Failed to deallocate grid%soilt060. ')
 endif
ENDIF
IF ( ASSOCIATED( grid%soilt100 ) ) THEN
  DEALLOCATE(grid%soilt100,STAT=ierr)
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",3995,&
'frame/module_domain.f: Failed to deallocate grid%soilt100. ')
 endif
ENDIF
...
ENDIF
IF ( ASSOCIATED( grid%el_mynn ) ) THEN
  DEALLOCATE(grid%el_mynn,STAT=ierr)
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",5633,&
'frame/module_domain.f: Failed to deallocate grid%el_mynn. ')
 endif
ENDIF
...
ENDIF
IF ( ASSOCIATED( grid%gd_cloud_b ) ) THEN
  DEALLOCATE(grid%gd_cloud_b,STAT=ierr)
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",7090,&
'frame/module_domain.f: Failed to deallocate grid%gd_cloud_b. ')
 endif
ENDIF
IF ( ASSOCIATED( grid%gd_cloud2_b ) ) THEN
  DEALLOCATE(grid%gd_cloud2_b,STAT=ierr)
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",7097,&
'frame/module_domain.f: Failed to deallocate grid%gd_cloud2_b. ')
 endif
ENDIF
