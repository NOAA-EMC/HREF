...
!tst      print *,'GRID ALLOCATED',ITOT,' kret',kret
      ...
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K, &
                     KPDS,KGDS,MASK,GRID,ZSFC,GFLD_S,IRET,ISTAT)
...
! get surface pressure
       ...
       JPDTN   = 0
        ...
        J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,PSFC,GFLD,IRET,ISTAT)
...
!                  UNPACK,K,GFLD,IRET)
        ...
        J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,RTYPE,GFLD,IRET,ISTAT)
...
! lowest wet bulb zero level
       ...
       JPDT(10) = 245
        ...
        J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,WETFRZ,GFLD,IRET,ISTAT)
...
! visibility 
       ...
       JPDT(10) = 1
        J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,VIS,GFLD,IRET,ISTAT)
...
! 2-m temp
       ...
       JPDT(12) = 2
        J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,T2,GFLD,IRET,ISTAT)
...
! 2-m spec hum
       ...
       JPDT(12) = 2
        J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,Q2,GFLD,IRET,ISTAT)
...
! 2-m dew point 
       ...
       JPDT(12) = 2
        J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,D2,GFLD,IRET,ISTAT)
...
! 10-m U
       ...
       JPDT(12) = 10
        ...
        J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,U10,GFLD,IRET,ISTAT)
...
! 10-m V
      ...
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,V10,GFLD,IRET,ISTAT)
...
!! 225 is vegetation type, not vegetation fraction
       ...
       JPDT(12) = -9999
        ...
        J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,VEG,GFLD,IRET,ISTAT)
...
! Best Liftex Index 
      if (lfull.or.lanl) then
       ...
       JPDT(10) = -9999
        J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,BLI,GFLD,IRET,ISTAT)
...
! Read 3-hr Precip 
      ...
      CALL SETVAR_g2(LUGP3,LUGP3I,NUMVP,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,P03M,GFLD8_S,IRET,ISTAT)
...
! 3-hr Snow 
      ...
      CALL SETVAR_g2(LUGS3,LUGS3I,NUMVS,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,SN03,GFLD,IRET,ISTAT)
...
! Read 6-hr Precip 
      ...
      CALL SETVAR_g2(LUGP6,LUGP6I,NUMVP,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,P06M,GFLD,IRET,ISTAT)
...
!     6-hr snow 
      ...
      CALL SETVAR_g2(LUGS6,LUGS6I,NUMVS,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,SN06,GFLD,IRET,ISTAT)
...
! Read  12-hr Precip
      ...
      CALL SETVAR_g2(LUGP12,LUGP12I,NUMVP,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,P12M,GFLD,IRET,ISTAT)
        ENDIF
      ENDIF
...
!        print*, 'THOLD(253,131,2): ', THOLD(253,131,2)
       ...
       JPDT(12) = 2
        J=0
      CALL SETVAR_g2(LUGT1,LUGT1I,NUMVALT,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,DHOLD(:,:,2),GFLD,IRET,ISTAT)
      ...
      CALL SETVAR_g2(LUGT2,LUGT2I,NUMVALT,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,THOLD(:,:,3),GFLD,IRET,ISTAT)
       ...
       JPDT(12) = 2
        J=0
      CALL SETVAR_g2(LUGT2,LUGT2I,NUMVALT,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,DHOLD(:,:,3),GFLD,IRET,ISTAT)
...
! Get min/max temperature values for full 12-hr period for F12,24...
      ...
      CALL SETVAR_g2(LUGTA,LUGTB,NUMVALT,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,THOLD(:,:,KT),GFLD,IRET,ISTAT)
       ...
       JPDT(12) = 2
        J=0
      CALL SETVAR_g2(LUGTA,LUGTB,NUMVALT,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,DHOLD(:,:,KT),GFLD,IRET,ISTAT)
...
!        JIDS=-9999
      ...
      DO LL=1,KMAX
       ...
       JPDT(12) = LL
        ...
        J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,& 
                     KPDS,KGDS,MASK,GRID,PMID(:,:,LL),GFLD,IRET,ISTAT)
...
!   get the vertical profile of height 
      ...
      DO LL=1,KMAX  
       ...
       JPDT(12) = LL
        ...
        J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,&
                     KPDS,KGDS,MASK,GRID,HGHT(:,:,LL),GFLD,IRET,ISTAT)
        if (IRET .eq. 0) then
...
!mptest       J=K
       ...
       JPDT(12) = LL
        ...
        J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,&
                     KPDS,KGDS,MASK,GRID,T(:,:,LL),GFLD,IRET,ISTAT)
...
!   950 mb temperature
      ...
      J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,&
                     KPDS,KGDS,MASK,GRID,T950,GFLD,IRET,ISTAT)
...
!   850 mb temperature
      ...
      J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,&
                     KPDS,KGDS,MASK,GRID,T850,GFLD,IRET,ISTAT)
...
!   700 mb temperature
      ...
      J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,&
                     KPDS,KGDS,MASK,GRID,T700,GFLD,IRET,ISTAT)
...
!   500 mb temperature
      ...
      J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,&
                     KPDS,KGDS,MASK,GRID,T500,GFLD,IRET,ISTAT)
...
!   850 mb RH
      ...
      J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,&
                     KPDS,KGDS,MASK,GRID,RH850,GFLD,IRET,ISTAT)
...
!   700 mb RH
      ...
      J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,&
                     KPDS,KGDS,MASK,GRID,RH700,GFLD,IRET,ISTAT)
...
!  sfc wind gust 
      ...
      J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,&
                     KPDS,KGDS,MASK,GRID,GUST,GFLD,IRET,ISTAT)
...
! composite reflectivity
      ...
      J=0
      CALL SETVAR_g2(LUGB,LUGI,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K,&
                     KPDS,KGDS,MASK,GRID,REFC,GFLD,IRET,ISTAT)
...
!        JPDS(5) = 73
!        JPDS(6) = 214
!        CALL SETVAR(LUGB,LUGI,NUMVAL,J,JPDS,JGDS,KF, K,KPDS,KGDS,MASK,GRID,LCLD,GFLD,IRET,ISTAT)
!        JPDS(5) = 74
!        JPDS(6) = 224
!        CALL SETVAR(LUGB,LUGI,NUMVAL,J,JPDS,JGDS,KF, K,KPDS,KGDS,MASK,GRID,MCLD,GFLD,IRET,ISTAT)
!        JPDS(5) = 75
!        JPDS(6) = 234
!        CALL SETVAR(LUGB,LUGI,NUMVAL,J,JPDS,JGDS,KF, K,KPDS,KGDS,MASK,GRID,HCLD,GFLD,IRET,ISTAT)
       endif 
...
!      JPDS(5) = 191 
!      JPDS(6) = 001
!      CALL SETVAR(LUGB2,LUGI2,NUMVAL2,J,JPDS,JGDS,KF, K,KPDS,KGDS,MASK,GRID,S3REF01,GFLD,IRET,ISTAT)
      ...
      CALL SETVAR_g2(LUGB2,LUGI2,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K, &
                     KPDS,KGDS,MASK,GRID,S3REF01,GFLD,IRET,ISTAT)
...
!      JPDS(5) = 191 
!      JPDS(6) = 001
!      CALL SETVAR(LUGB2,LUGI2,NUMVAL2,J,JPDS,JGDS,KF, K,KPDS,KGDS,MASK,GRID,S3REF10,GFLD,IRET,ISTAT)
      ...
      CALL SETVAR_g2(LUGB2,LUGI2,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K, &
                     KPDS,KGDS,MASK,GRID,S3REF10,GFLD,IRET,ISTAT)
      IF(IRET .NE. 0 )RETURN
...
!      JPDS(5) = 191 
!      JPDS(6) = 001
!      CALL SETVAR(LUGB2,LUGI2,NUMVAL2,J,JPDS,JGDS,KF, K,KPDS,KGDS,MASK,GRID,S3REF50,GFLD,IRET,ISTAT)
      ...
      CALL SETVAR_g2(LUGB2,LUGI2,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K, &
                     KPDS,KGDS,MASK,GRID,S3REF50,GFLD,IRET,ISTAT)
...
!      JPDS(5) = 191 
!      JPDS(6) = 001
!      CALL SETVAR(LUGB2,LUGI2,NUMVAL2,J,JPDS,JGDS,KF, K,KPDS,KGDS,MASK,GRID,S6REF01,GFLD,IRET,ISTAT)
      ...
      CALL SETVAR_g2(LUGB2,LUGI2,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K, &
                     KPDS,KGDS,MASK,GRID,S6REF01,GFLD,IRET,ISTAT)
...
!      JPDS(5) = 191 
!      JPDS(6) = 001
!      CALL SETVAR(LUGB2,LUGI2,NUMVAL2,J,JPDS,JGDS,KF, K,KPDS,KGDS,MASK,GRID,S6REF10,GFLD,IRET,ISTAT)
      ...
      CALL SETVAR_g2(LUGB2,LUGI2,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K, &
                     KPDS,KGDS,MASK,GRID,S6REF10,GFLD,IRET,ISTAT)
...
!      JPDS(5) = 191 
!      JPDS(6) = 001
!      CALL SETVAR(LUGB2,LUGI2,NUMVAL2,J,JPDS,JGDS,KF, K,KPDS,KGDS,MASK,GRID,S6REF50,GFLD,IRET,ISTAT)
      ...
      CALL SETVAR_g2(LUGB2,LUGI2,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K, &
                     KPDS,KGDS,MASK,GRID,S6REF50,GFLD,IRET,ISTAT)
...
!      CALL SETVAR(LUGB2,LUGI2,NUMVAL2,J,JPDS,JGDS,KF, K,KPDS,KGDS,MASK,GRID,S12REF01,GFLD,IRET,ISTAT) 

       J = 10
       JPDT(2) = 008

      CALL SETVAR_g2(LUGB2,LUGI2,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K, &
                     KPDS,KGDS,MASK,GRID,S12REF01,GFLD,IRET,ISTAT)
! 12-hr probability of 0.1"
!      J = J+2 
!      CALL SETVAR(LUGB2,LUGI2,NUMVAL2,J,JPDS,JGDS,KF, K,KPDS,KGDS,MASK,GRID,S12REF10,GFLD,IRET,ISTAT)
       J = J+2
       JPDT(2) = 008

      CALL SETVAR_g2(LUGB2,LUGI2,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K, &
                     KPDS,KGDS,MASK,GRID,S12REF10,GFLD,IRET,ISTAT)

! 12-hr probability of 0.5"
!      J = J+2
!      CALL SETVAR(LUGB2,LUGI2,NUMVAL2,J,JPDS,JGDS,KF, K,KPDS,KGDS,MASK,GRID,S12REF50,GFLD,IRET,ISTAT)

       J = J+2
       JPDT(2) = 008

      CALL SETVAR_g2(LUGB2,LUGI2,NUMVAL,J,JDISC,JIDS,JPDTN,JPDT,JGDTN,JGDT,KF,K, &
                     KPDS,KGDS,MASK,GRID,S12REF50,GFLD,IRET,ISTAT)
