   ...
   pbl_select: SELECT CASE(bl_pbl_physics)
      ...
      CASE (YSUSCHEME)
        CALL wrf_debug(100,'in YSU PBL')
           ...
           ELSE
               CALL wrf_error_fatal3 ( "module_pbl_driver.b" , 431 , 'Lack arguments to call YSU pbl')
           ENDIF
      ...
      CASE (MRFSCHEME)
           ...
           ELSE
               CALL wrf_error_fatal3 ( "module_pbl_driver.b" , 466 , 'Lack arguments to call MRF pbl')
           ENDIF
      ...
      CASE (GFSSCHEME)
           ...
           ELSE
               CALL wrf_error_fatal3 ( "module_pbl_driver.b" , 493 , 'Lack arguments to call GFS pbl')
           ENDIF
      ...
      CASE (MYJPBLSCHEME)
           ...
           ELSE
               CALL wrf_error_fatal3 ( "module_pbl_driver.b" , 521 , 'Lack arguments to call MYJ pbl')
           ENDIF

     CASE DEFAULT

       WRITE( message , * ) 'The pbl option does not exist: bl_pbl_physics = ', bl_pbl_physics
       CALL wrf_error_fatal3 ( "module_pbl_driver.b" , 527 ,  message )
