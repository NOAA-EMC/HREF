...
!              PRINT *,QG = 0 AT THE SURFACE!!!!!!!    ! JSK MODS
              CALL wrf_error_fatal3 ( "module_cu_kfeta.b" , 1652 ,  'QG, QG(NK).LT.0') ! JSK MODS
            ENDIF                                       ! JSK MODS
            NK1=NK+1
            IF(NK.EQ.LTOP)THEN
              NK1=KLCL
...
!    *               U0(K),V0(K),DP(K)/100.,W0AVG(I,J,K)
 310        CONTINUE
            IF(ISTOP.EQ.1)THEN
              CALL wrf_error_fatal3 ( "module_cu_kfeta.b" , 2056 ,  'KAIN-FRITSCH, istop=1, diags' )
            ENDIF
!         ENDIF
  4455  format(8f11.3) 
       ENDIF
...
!              PRINT *,THIS COMBINATION OF IMOIST, IEXICE, IICE NOT ALLOWED!
              CALL wrf_error_fatal3 ( "module_cu_kfeta.b" , 2193 ,  'KAIN-FRITSCH, THIS COMBINATION OF IMOIST, IEXICE, IICE NOT ALLOWED' )
          ENDIF
