...
!!!!  IF (CHECK) 1020,1020,1025
  ...
  360   FORMAT(' ERROR,I=',I3,'LL=',I3,'CHECK=',F20.10)
        CALL wrf_error_fatal3 ( "module_ra_gfdleta.b" , 8260 ,  errmess )
      ENDIF
 1010 CONTINUE
...
!CC         READ (5,202) NMETHD
      ...
      CALL wrf_error_fatal3 ( "module_ra_gfdleta.b" , 8803 ,  'SUBROUTINE CO2INT: 8746' )
!NOV89  621   ITAP1=20
621   ITAP1=ITAPE
!NOV89
      NTAP=1
...
!
 ...
 2063   CONTINUE
      ...
      IF ( etarad_unit61 < 0 ) THEN
        CALL wrf_error_fatal3 ( "module_ra_gfdleta.b" , 9643 ,  'module_ra_gfdleta: co2o3: Can not find unused fortran unit to read in lookup table.' )
      ENDIF
      CALL wrf_dm_bcast_bytes ( etarad_unit62 , 4 )
      IF ( etarad_unit62 < 0 ) THEN
        CALL wrf_error_fatal3 ( "module_ra_gfdleta.b" , 9647 ,  'module_ra_gfdleta: co2o3: Can not find unused fortran unit to read in lookup table.' )
      ENDIF
      CALL wrf_dm_bcast_bytes ( etarad_unit63 , 4 )
      IF ( etarad_unit63 < 0 ) THEN
        CALL wrf_error_fatal3 ( "module_ra_gfdleta.b" , 9651 ,  'module_ra_gfdleta: co2o3: Can not find unused fortran unit to read in lookup table.' )
      ENDIF
        IF ( wrf_dm_on_monitor() ) THEN
...
9014 CONTINUE
     ...
     CALL wrf_error_fatal3 ( "module_ra_gfdleta.b" , 10162 , errmess)
!----------------------------------------------------------------------
