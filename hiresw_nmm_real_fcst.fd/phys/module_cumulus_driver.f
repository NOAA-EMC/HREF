...
!-- CLDEFI        cloud efficiency (for BMJ scheme) (dimensionless)
...
! DONT JUDGE TIME STEP HERE, SINCE KF NEEDS ACCUMULATED W FIELD.
...
! SET START AND END POINTS FOR TILES
   ...
   cps_select: SELECT CASE(config_flags%cu_physics)
	...
	write(0,*) 'call BMJDRV... DT,ITIMESTEP,STEPCU: ',  DT,ITIMESTEP,STEPCU
!	write(0,*) ht extremes: , minval(ht), maxval(ht)
!	write(0,*) ht(20,20),ht(40,40): , ht(20,20),ht(40,40)
            ...
            CALL BMJDRV(DT,itimestep,STEPCU,                      &
                 ...
                 th_phy,t_phy,                                    &
                 moist(ims,kms,jms,P_QV),                         &
!mp0503          p8w,p_phy,pi_phy,rho_phy,dz8w,w,ht,              &
                 p8w,p_phy,pi_phy,rho_phy,dz8w,                   &
                 CP,R_d,XLV,XLS,g,SVPT0,EP_1,                     &
     ...
     CASE (KFETASCHEME)
          ...
          CALL KF_ETA_CPS(DT,itimestep,DX,                      &
               ...
               EP_2,SVP1,SVP2,SVP3,SVPT0,                       &
               P_QR,P_QI,P_QS,PARAM_FIRST_SCALAR,STEPCU,        &
               CU_ACT_FLAG,warm_rain,HTOP,HBOT,                 &
               ids,ide, jds,jde, kds,kde,                       &
               ims,ime, jms,jme, kms,kme,                       &
               its,ite, jts,jte, kts,kte                        )
     CASE (GDSCHEME)
