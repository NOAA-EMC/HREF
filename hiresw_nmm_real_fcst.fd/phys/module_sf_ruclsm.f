...
!      CANWAT - CANOPY MOISTURE CONTENT (M)
...
! soil moisture minus residual is nitialized from RUC background
    ...
    IF ( wrf_at_debug_level(200) ) THEN
...
!--- input variables
                ...
                canwat(I,J),vegfra(I,J),alb(I,J),znt(I,J),       &
!--- soil fixed fields
                QWRTZ,                                           &
                rhocs,dqm,qmin,ref,                              &
                wilt,psis,bclh,ksat,                             &
...
! heat content contribution into heat budget equation. Rains temperature
...
!--------------------------------------------------------------------------
  ...
  SUBROUTINE LSMRUCINIT( SMFR3D,TSLB,SMOIS,ISLTYP,nzs,             &
                     ids,ide, jds,jde, kds,kde,                    &
                     ims,ime, jms,jme, kms,kme,                    &
                     its,ite, jts,jte, kts,kte                     )
