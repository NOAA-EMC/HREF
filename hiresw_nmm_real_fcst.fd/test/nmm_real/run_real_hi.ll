...
cat namelist.input_hiin | sed s:YSTART:$ystart: | sed s:MSTART:$mstart: \
...
cp /gpfstmp/wx20py/dataroot/$SIDOM/siprd/real* .
...
cp /emc2/wx20py/wrf_nmm/WRFV1/main/real.exe .
