...
!  slow version of code, well call interp routine for each column
   ...
   do i = its, min(ide-1,ite)
      ...
      call interp_p( geopotential, pressure, 50000., interp_output,  &
  ...
  character*256 mess
    ...
    do while( pk .gt. pressure )
      ...
      if(kp .gt. ke) then
        ...
        write(0,*)'p: ',p
        CALL wrf_error_fatal3 ( "module_compute_geop.b" , 81 ,  mess )
      end if
