...
MODULE module_state_description
  ! package constants
  INTEGER, PARAMETER :: dyn_eh = 1
  INTEGER, PARAMETER :: dyn_em = 2
  INTEGER, PARAMETER :: dyn_slt = 3
  ...
  INTEGER, PARAMETER :: ncepcloud3 = 3
  INTEGER, PARAMETER :: ncepcloud5 = 4
  INTEGER, PARAMETER :: etampnew = 5
  INTEGER, PARAMETER :: etampscheme = 99
