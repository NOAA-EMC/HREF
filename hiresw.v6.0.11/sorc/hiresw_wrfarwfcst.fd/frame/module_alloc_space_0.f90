...
((((em31)-(sm31)+1))*(((model_config_rec%num_metgrid_levels)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  grid%tail_statevars%Description = 'ice no concentration'
...
((((em31)-(sm31)+1))*(((model_config_rec%num_metgrid_levels)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  grid%tail_statevars%Description = 'rain no concentration'
  grid%tail_statevars%Units = 'm-3'
  grid%tail_statevars%Type = 'r'
  grid%tail_statevars%ProcOrient = ' '
  grid%tail_statevars%MemoryOrder = 'XZY'
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",11113,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",11358,&
...
ENDIF
IF(in_use_for_config(id,'soilm001').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ALLOCATE(grid%soilm001(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",14361,&
    'frame/module_domain.f: Failed to allocate grid%soilm001(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%soilm001=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'soilm001'
  grid%tail_statevars%DataName = 'SOILM001'
  grid%tail_statevars%Description = 'LAYER SOIL MOISTURE'
  grid%tail_statevars%Units = 'm3 m-3'
  grid%tail_statevars%Type = 'r'
  grid%tail_statevars%ProcOrient = ' '
  ...
  grid%tail_statevars%Restart = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%soilm001
  grid%tail_statevars%streams(1) = 67108864
  grid%tail_statevars%streams(2) = 0
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%soilm001(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",14411,&
    'frame/module_domain.f: Failed to allocate grid%soilm001(1,1).  ')
  endif
ENDIF
IF(in_use_for_config(id,'soilm004').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ALLOCATE(grid%soilm004(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",14420,&
    'frame/module_domain.f: Failed to allocate grid%soilm004(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%soilm004=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'soilm004'
  grid%tail_statevars%DataName = 'SOILM004'
  grid%tail_statevars%Description = 'LAYER SOIL MOISTURE'
  grid%tail_statevars%Units = 'm3 m-3'
  grid%tail_statevars%Type = 'r'
  grid%tail_statevars%ProcOrient = ' '
  ...
  grid%tail_statevars%Restart = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%soilm004
  grid%tail_statevars%streams(1) = 67108864
  grid%tail_statevars%streams(2) = 0
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%soilm004(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",14470,&
    'frame/module_domain.f: Failed to allocate grid%soilm004(1,1).  ')
  endif
ENDIF
...
ENDIF
IF(in_use_for_config(id,'soilm010').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ALLOCATE(grid%soilm010(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",14538,&
    'frame/module_domain.f: Failed to allocate grid%soilm010(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%soilm010=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'soilm010'
  grid%tail_statevars%DataName = 'SOILM010'
  grid%tail_statevars%Description = 'LAYER SOIL MOISTURE'
  grid%tail_statevars%Units = 'm3 m-3'
  grid%tail_statevars%Type = 'r'
  grid%tail_statevars%ProcOrient = ' '
  ...
  grid%tail_statevars%Restart = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%soilm010
  grid%tail_statevars%streams(1) = 67108864
  grid%tail_statevars%streams(2) = 0
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%soilm010(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",14588,&
    'frame/module_domain.f: Failed to allocate grid%soilm010(1,1).  ')
  endif
ENDIF
...
ENDIF
IF(in_use_for_config(id,'soilm030').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ALLOCATE(grid%soilm030(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",14656,&
    'frame/module_domain.f: Failed to allocate grid%soilm030(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%soilm030=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'soilm030'
  grid%tail_statevars%DataName = 'SOILM030'
  grid%tail_statevars%Description = 'LAYER SOIL MOISTURE'
  grid%tail_statevars%Units = 'm3 m-3'
  grid%tail_statevars%Type = 'r'
  grid%tail_statevars%ProcOrient = ' '
  ...
  grid%tail_statevars%Restart = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%soilm030
  grid%tail_statevars%streams(1) = 67108864
  grid%tail_statevars%streams(2) = 0
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%soilm030(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",14706,&
    'frame/module_domain.f: Failed to allocate grid%soilm030(1,1).  ')
  endif
ENDIF
...
ENDIF
IF(in_use_for_config(id,'soilm060').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ALLOCATE(grid%soilm060(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",14774,&
    'frame/module_domain.f: Failed to allocate grid%soilm060(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%soilm060=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'soilm060'
  grid%tail_statevars%DataName = 'SOILM060'
  grid%tail_statevars%Description = 'LAYER SOIL MOISTURE'
  grid%tail_statevars%Units = 'm3 m-3'
  grid%tail_statevars%Type = 'r'
  grid%tail_statevars%ProcOrient = ' '
  ...
  grid%tail_statevars%Restart = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%soilm060
  grid%tail_statevars%streams(1) = 67108864
  grid%tail_statevars%streams(2) = 0
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%soilm060(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",14824,&
    'frame/module_domain.f: Failed to allocate grid%soilm060(1,1).  ')
  endif
ENDIF
IF(in_use_for_config(id,'soilm100').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ALLOCATE(grid%soilm100(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",14833,&
    'frame/module_domain.f: Failed to allocate grid%soilm100(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%soilm100=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'soilm100'
  grid%tail_statevars%DataName = 'SOILM100'
  grid%tail_statevars%Description = 'LAYER SOIL MOISTURE'
  grid%tail_statevars%Units = 'm3 m-3'
  grid%tail_statevars%Type = 'r'
  grid%tail_statevars%ProcOrient = ' '
  ...
  grid%tail_statevars%Restart = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%soilm100
  grid%tail_statevars%streams(1) = 67108864
  grid%tail_statevars%streams(2) = 0
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%soilm100(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",14883,&
    'frame/module_domain.f: Failed to allocate grid%soilm100(1,1).  ')
  endif
ENDIF
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",15532,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",15718,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",15777,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",15886,&
...
ENDIF
IF(in_use_for_config(id,'soilt001').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ALLOCATE(grid%soilt001(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",16013,&
    'frame/module_domain.f: Failed to allocate grid%soilt001(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%soilt001=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'soilt001'
  grid%tail_statevars%DataName = 'SOILT001'
  grid%tail_statevars%Description = 'LAYER SOIL TEMPERATURE'
  grid%tail_statevars%Units = 'K'
  grid%tail_statevars%Type = 'r'
  grid%tail_statevars%ProcOrient = ' '
  ...
  grid%tail_statevars%Restart = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%soilt001
  grid%tail_statevars%streams(1) = 67108864
  grid%tail_statevars%streams(2) = 0
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%soilt001(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",16063,&
    'frame/module_domain.f: Failed to allocate grid%soilt001(1,1).  ')
  endif
ENDIF
IF(in_use_for_config(id,'soilt004').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ALLOCATE(grid%soilt004(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",16072,&
    'frame/module_domain.f: Failed to allocate grid%soilt004(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%soilt004=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'soilt004'
  grid%tail_statevars%DataName = 'SOILT004'
  grid%tail_statevars%Description = 'LAYER SOIL TEMPERATURE'
  grid%tail_statevars%Units = 'K'
  grid%tail_statevars%Type = 'r'
  grid%tail_statevars%ProcOrient = ' '
  ...
  grid%tail_statevars%Restart = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%soilt004
  grid%tail_statevars%streams(1) = 67108864
  grid%tail_statevars%streams(2) = 0
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%soilt004(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",16122,&
    'frame/module_domain.f: Failed to allocate grid%soilt004(1,1).  ')
  endif
ENDIF
...
ENDIF
IF(in_use_for_config(id,'soilt010').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ALLOCATE(grid%soilt010(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",16190,&
    'frame/module_domain.f: Failed to allocate grid%soilt010(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%soilt010=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'soilt010'
  grid%tail_statevars%DataName = 'SOILT010'
  grid%tail_statevars%Description = 'LAYER SOIL TEMPERATURE'
  grid%tail_statevars%Units = 'K'
  grid%tail_statevars%Type = 'r'
  grid%tail_statevars%ProcOrient = ' '
  ...
  grid%tail_statevars%Restart = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%soilt010
  grid%tail_statevars%streams(1) = 67108864
  grid%tail_statevars%streams(2) = 0
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%soilt010(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",16240,&
    'frame/module_domain.f: Failed to allocate grid%soilt010(1,1).  ')
  endif
ENDIF
...
ENDIF
IF(in_use_for_config(id,'soilt030').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ALLOCATE(grid%soilt030(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",16308,&
    'frame/module_domain.f: Failed to allocate grid%soilt030(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%soilt030=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'soilt030'
  grid%tail_statevars%DataName = 'SOILT030'
  grid%tail_statevars%Description = 'LAYER SOIL TEMPERATURE'
  grid%tail_statevars%Units = 'K'
  grid%tail_statevars%Type = 'r'
  grid%tail_statevars%ProcOrient = ' '
  ...
  grid%tail_statevars%Restart = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%soilt030
  grid%tail_statevars%streams(1) = 67108864
  grid%tail_statevars%streams(2) = 0
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%soilt030(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",16358,&
    'frame/module_domain.f: Failed to allocate grid%soilt030(1,1).  ')
  endif
ENDIF
...
ENDIF
IF(in_use_for_config(id,'soilt060').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ALLOCATE(grid%soilt060(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",16426,&
    'frame/module_domain.f: Failed to allocate grid%soilt060(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%soilt060=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'soilt060'
  grid%tail_statevars%DataName = 'SOILT060'
  grid%tail_statevars%Description = 'LAYER SOIL TEMPERATURE'
  grid%tail_statevars%Units = 'K'
  grid%tail_statevars%Type = 'r'
  grid%tail_statevars%ProcOrient = ' '
  ...
  grid%tail_statevars%Restart = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%soilt060
  grid%tail_statevars%streams(1) = 67108864
  grid%tail_statevars%streams(2) = 0
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%soilt060(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",16476,&
    'frame/module_domain.f: Failed to allocate grid%soilt060(1,1).  ')
  endif
ENDIF
IF(in_use_for_config(id,'soilt100').AND.(.NOT.grid%is_intermediate))THEN
  num_bytes_allocated = num_bytes_allocated + &
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ALLOCATE(grid%soilt100(sm31:em31,sm33:em33),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",16485,&
    'frame/module_domain.f: Failed to allocate grid%soilt100(sm31:em31,sm33:em33). ')
  endif
  IF ( setinitval .EQ. 1 .OR. setinitval .EQ. 3 ) grid%soilt100=initial_data_value
  IF (.NOT.grid%is_intermediate) THEN
  ALLOCATE( grid%tail_statevars%next )
  grid%tail_statevars => grid%tail_statevars%next
  NULLIFY( grid%tail_statevars%next )
  grid%tail_statevars%VarName = 'soilt100'
  grid%tail_statevars%DataName = 'SOILT100'
  grid%tail_statevars%Description = 'LAYER SOIL TEMPERATURE'
  grid%tail_statevars%Units = 'K'
  grid%tail_statevars%Type = 'r'
  grid%tail_statevars%ProcOrient = ' '
  ...
  grid%tail_statevars%Restart = .FALSE.
  grid%tail_statevars%scalar_array = .FALSE.
  grid%tail_statevars%rfield_2d => grid%soilt100
  grid%tail_statevars%streams(1) = 67108864
  grid%tail_statevars%streams(2) = 0
  grid%tail_statevars%sd1 = ids
  grid%tail_statevars%ed1 = (ide-1)
  ...
  ENDIF
ELSE
  ALLOCATE(grid%soilt100(1,1),STAT=ierr)
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",16535,&
    'frame/module_domain.f: Failed to allocate grid%soilt100(1,1).  ')
  endif
ENDIF
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",16603,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",17134,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",17538,&
...
((((model_config_rec%ts_buf_size)-(1)+1))*(((model_config_rec%max_ts_locs)-(1)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",17777,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",17825,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",17882,&
...
((((model_config_rec%ts_buf_size)-(1)+1))*(((model_config_rec%max_ts_locs)-(1)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",17891,&
...
((((model_config_rec%ts_buf_size)-(1)+1))*(((model_config_rec%max_ts_locs)-(1)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",17948,&
...
((((model_config_rec%ts_buf_size)-(1)+1))*(((model_config_rec%max_ts_locs)-(1)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18119,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18281,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18338,&
...
((((model_config_rec%ts_buf_size)-(1)+1))*(((model_config_rec%max_ts_locs)-(1)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18347,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18452,&
...
((((model_config_rec%ts_buf_size)-(1)+1))*(((model_config_rec%max_ts_locs)-(1)+1))*(((em32)-(sm32)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18575,&
...
((((model_config_rec%ts_buf_size)-(1)+1))*(((model_config_rec%max_ts_locs)-(1)+1))*(((em32)-(sm32)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18689,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18737,&
...
((((model_config_rec%num_soil_layers)-(1)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18746,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18908,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19026,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19094,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19262,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19321,&
...
((((em31)-(sm31)+1))*(((model_config_rec%num_urban_hi)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19330,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19439,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19498,&
...
((((em31)-(sm31)+1))*(((model_config_rec%num_urban_hi)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19507,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19625,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19675,&
...
((((em31)-(sm31)+1))*(((4)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19684,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19734,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19743,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19793,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19802,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19852,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19911,&
...
((((em31)-(sm31)+1))*(((4)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19979,&
...
((((em31)-(sm31)+1))*(((4)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20038,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20097,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20147,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20265,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20324,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20383,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20451,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20619,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20628,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20737,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20914,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20923,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20982,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21041,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21150,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21159,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21209,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21218,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21327,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21454,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21563,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21572,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21622,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21631,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21740,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21799,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21858,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21962,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22012,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22071,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22156,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22215,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22265,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22274,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22324,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22442,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22501,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22510,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22569,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22628,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22687,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22737,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22746,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22796,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22805,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22855,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22914,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22923,&
