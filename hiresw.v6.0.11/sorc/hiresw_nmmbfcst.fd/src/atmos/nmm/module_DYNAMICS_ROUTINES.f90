...
!
!        if (mype .eq. 0) then
!        write(0,*) 'dvol, rdvol defsk: ', 1000*(timef()-btim)
!        btim=timef()
!        endif
...
!        if (mype .eq. 0) then
!        write(0,*) 'local sums?: ', 1000*(timef()-btim)
!        btim=timef()
!        endif
!
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
        ...
        call mpi_bcast(gsums,(kse-kss+1)*2 &
                      ,mpi_double_precision,0,mpi_comm_comp,ierr)
!        if (mype .eq. 0) then
!        write(0,*) 'global reduce: ', 1000*(timef()-btim)
!        btim=timef()
!        endif
...
!.......................................................................
!        if (mype .eq. 0) then
!        write(0,*) 'tcs by species: ', 1000*(timef()-btim)
!        btim=timef()
!        endif
!
!-----------------------------------------------------------------------
      ...
      enddo
!        if (mype .eq. 0) then
!        write(0,*) 'indx_q2 tcs calc: ', 1000*(timef()-btim)
!        btim=timef()
!        endif
!
!-----------------------------------------------------------------------
