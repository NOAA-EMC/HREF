...
!
          CALL ESMF_AttributeSet(state    =IMP_STATE                    &  !<-- The Domain import state
                                ...
                                ,count=NUM_DOMAINS_MAX              &  !<-- Number of items in the array
...
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
                CALL ESMF_AttributeSet(bundle=solver_int_state%BUNDLE_ARRAY(1)   &  !<-- The output Bundle
...
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
                CALL ESMF_AttributeSet(bundle=solver_int_state%BUNDLE_ARRAY(2)  &  !<-- The restart Bundle
                                      ,name       =solver_int_state%VARS(N)%VBL_NAME &  !<-- Name of the integer scalar
...
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
                CALL ESMF_AttributeSet(bundle=solver_int_state%BUNDLE_ARRAY(1)  &  !<-- The history Bundle
...
!
        CALL ESMF_AttributeGet(state    =IMP_STATE                      &  !<-- The Domain import state
                              ...
                              ,count=N8                             &  !<-- # of words in index limits of update data
