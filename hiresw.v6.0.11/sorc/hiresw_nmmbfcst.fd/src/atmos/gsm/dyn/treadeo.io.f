...
!   Jun 2013, H. Juang: add spectral moisture in case of ndsl 
!
...
!      endif
     ...
     &   minval(grid_gr(:,1:lats_node_a,g_gz)),'t=',
     &   maxval(grid_gr(:,1:lats_node_a,g_ttm:g_ttm+levs-1)),
     &   minval(grid_gr(:,1:lats_node_a,g_ttm:g_ttm+levs-1)),'q=',
     &   maxval(grid_gr(:,1:lats_node_a,g_rm:g_rm+levh-1)),
     &   minval(grid_gr(:,1:lats_node_a,g_rm:g_rm+levh-1)),'u=',
     &   maxval(grid_gr(:,1:lats_node_a,g_uum:g_uum+levs-1)),
     &   minval(grid_gr(:,1:lats_node_a,g_uum:g_uum+levs-1)),'v=',
     &   maxval(grid_gr(:,1:lats_node_a,g_vvm:g_vvm+levs-1)),
     &   minval(grid_gr(:,1:lats_node_a,g_vvm:g_vvm+levs-1))
!  
