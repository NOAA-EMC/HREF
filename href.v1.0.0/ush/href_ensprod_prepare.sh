...
for ff in 03 06 09 12 15 18; do
 ...
 echo "cp $rundir/$ff/href.mean.t${cyc}z.f$ff $COMOUT" >> $rundir/run_ensprod_poe_one.$ff
 echo "cp $rundir/$ff/href.prob.t${cyc}z.f$ff $COMOUT" >> $rundir/run_ensprod_poe_one.$ff
 echo "cp $rundir/$ff/href.sprd.t${cyc}z.f$ff $COMOUT" >> $rundir/run_ensprod_poe_one.$ff
